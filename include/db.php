...
define('DB_USER', 'your_db_user'); // Database user ## Datenbank Benutzername
define('DB_PASS', 'your_db_password'); // Database password ## Datenbank Passwort
define('DB_NAME', 'your_db_name'); // Database name ## Datenbank Name
