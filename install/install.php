...
<head>
	...
	<link rel="stylesheet" href="/assets/plugins/bootstrap/bootstrapv4/4.0.0/css/bootstrap.min.css" type="text/css" media="screen"/>
			...
			<div class="col-sm-12">
				...
				<div class="tsf-wizard tsf-wizard-1">
                    ...
                    <span><?= $tlinst["install"]["step1_1"] ?></span>
							...
							<li id="step2" <?php if (isset($_GET['step']) && $_GET['step'] == 2) {
								echo ' class="current"';
							} ?>>
                    ...
                    <span><?= $tlinst["install"]["step2_1"] ?></span>
							...
							<li id="step3" <?php if (isset($_GET['step']) && $_GET['step'] == 3) {
								echo ' class="current"';
							} ?>>
                    ...
                    <span><?= $tlinst["install"]["step3_1"] ?></span>
							...
							<li id="step4" <?php if (isset($_GET['step']) && $_GET['step'] == 4) {
								echo ' class="current"';
							} ?>>
                    ...
                    <span><?= $tlinst["install"]["step4_1"] ?></span>
							...
							<li id="step5" <?php if (isset($_GET['step']) && $_GET['step'] == 5) {
								echo ' class="current"';
							} ?>>
                    ...
                    <span><?= $tlinst["install"]["step5_1"] ?></span>
							...
							<li id="step5" <?php if (isset($_GET['step']) && $_GET['step'] == 6) {
								echo ' class="current"';
							} ?>>
					...
					<form method="post" action="install.php?step=2">
						...
						<table class="table">
							...
							<tr>
								...
								<td class="w-25">
									<input type="text" class="form-control" name="dbhost" id="dbhost" value="<?= $config['dbhost'] ?>">
								</td>
								<td class="w-50"></td>
							</tr>
							<tr>
								<td><?= $tlinst["install"]["form1_1"] ?></td>
								<td><input type="text" class="form-control" name="dbuser" id="dbuser" value="<?= $config['dbuser'] ?>">
								</td>
								<td></td>
							</tr>
							<tr>
								<td><?= $tlinst["install"]["form1_2"] ?></td>
								<td><input type="text" class="form-control" name="dbpass" id="dbpass" value="<?= $config['dbpass'] ?>">
								</td>
								<td></td>
							</tr>
							<tr>
								<td><?= $tlinst["install"]["form1_3"] ?></td>
								<td><input type="text" class="form-control" name="dbname" id="dbname" value="<?= $config['dbname'] ?>">
								</td>
								<td></td>
							</tr>
							<tr>
								...
								<td>
									<input type="text" class="form-control" name="dbprefix" id="dbprefix" value="<?= $config['dbprefix'] ?>">
								</td>
							...
							<tr>
								...
								<td>
									<input type="text" class="form-control" name="fullsitedomain" id="fullsitedomain" value="<?= $config['fullsitedomain'] ?>">
								</td>
							...
							<tr>
								...
								<td>
									<input type="text" class="form-control" name="filefolder" id="filefolder" value="<?= $config['filefolder'] ?>">
								</td>
				...
				<?php } else if (isset($_GET['step']) && $_GET['step'] == 2) { ?>
					...
					<form method="post" action="install.php?step=5">
						...
						<form id="company" method="post" action="install.php?step=4" enctype="multipart/form-data">
							...
							<div class="controls">
								<div class="d-flex justify-content-end">
									<button type="submit" name="useru" class="btn square btn-default"><?= $tlinst["install"]["superadmin"] ?>
						...
						<form role="form" name="user" method="post" action="install.php?step=5" enctype="multipart/form-data">
							...
							<table class="table">
								<tr>
									...
									<td>
										<input type="text" value="" class="form-control" name="onumber" placeholder="<?= $tlinst["install"]["form5_11"] ?>"/>
									</td>
								</tr>
								<tr>
				...
				<?php } else if (isset($_GET['step']) && $_GET['step'] == 6) { ?>
					<form id="company" method="post" action="install.php?step=6" enctype="multipart/form-data">
						...
						<div class="controls mt-4">
							<div class="d-flex justify-content-end">
								<button type="submit" class="btn square btn-default"><?= $tlinst["install"]["folder1"] ?>
									<i class="fa fa-chevron-right"></i></button>
							</div>
						</div>
...
<div id="footer">
	<div class="container">
		<div class="row">
			<p class="muted credit">Copyright 2016 - <?= date('Y') ?> by
				<a href="https://www.bluesat.cz" target="_blank">BLUESAT</a></p>
		</div>
	</div>
</div>
