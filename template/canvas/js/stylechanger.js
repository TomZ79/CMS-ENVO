...
$(document).ready(function () {
  ...
  // Dark or Light
  $(document).on('change', '#tpldesign', function () {
    tplcolor = $(this).val();

    //$('.tpljakweb').remove();
    if (tplcolor == "dark") {
      var csscolor = "dark.css";
    } else {
  ...
  // MiniNavbar Hide
  $('#mininavbarshow').on('change', function (e) {
    e.preventDefault();
    if ($(".mini-navbar").hasClass("hidden")) {
      $(".mini-navbar").removeClass("hidden");
    } else {
      $(".mini-navbar").addClass("hidden");
    }
  });

  // MiniNavbar TXT
  $(document).on('keyup', '#mininavtext', function (e) {
    e.preventDefault();
    $('#mosaic-mini-txt').html($(this).val());
  });

  // Mininavbar colour
  $('#mininavbarcolour').on('change', function (e) {
    e.preventDefault();
    if ($(".mini-navbar").hasClass("mini-navbar-dark")) {
  ...
  $(document).on('change', '#navbarstyle', function (e) {
    ...
    if ($('.navbar').hasClass("navbar-fixed-top")) {
      ...
      if (!$(".mini-navbar").length || $(".mini-navbar").hasClass("hidden")) {
        $('#sb-site').css("margin-top", "75px");
      } else {
        $('#sb-site').css("margin-top", "115px");
      }
      $('.navbar').css("margin-bottom", "auto").addClass("navbar-fixed-top");
    }
  });

  // Navbar colour (Black/White
  $('#navbarbw').on('change', function (e) {
    e.preventDefault();
  ...
  $('.colorh1').colorpicker({format: "hex"}).on('changeColor.colorpicker', function (e) {
    if ($('.colorh1').val()) $('h1, h2, h3, h4, h5, h6').css("color", e.color.toHex());
  });
  $('.colortxt').colorpicker({format: "hex"}).on('changeColor.colorpicker', function (e) {
    if ($('.colortxt').val()) $('body').css("color", e.color.toHex());
  });
