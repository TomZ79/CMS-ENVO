<?php if ($JAK_SHOW_NAVBAR) { ?>
	...
	<?php if (!empty($JAK_HOOK_SIDE_GRID) && $jkv["sidebar_location_tpl"] == "right") {
		include_once APP_PATH . 'template/jakweb/sidebar.php';
	} ?>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-footer col-md-4">
					...
					<?php if ($apedit) { ?>
						<a class="btn btn-default" title="<?php echo $tl["general"]["g"]; ?>" href="<?php echo $apedit; ?>"><i
								class="fa fa-pencil"></i></a>
						<?php if ($qapedit) { ?><a class="btn btn-default quickedit" title="<?php echo $tl["general"]["g176"]; ?>"
					...
					<div class="row">
						...
						<div class="col-footer col-md-4">
							...
							<?php if ($apedit) { ?>
								<a class="btn btn-default" title="<?php echo $tl["general"]["g"]; ?>" href="<?php echo $apedit; ?>"><i
										class="fa fa-pencil"></i></a>
								<?php if ($qapedit) { ?><a class="btn btn-default quickedit"
...
if ($JAK_SHOW_NAVBAR) { ?>
	...
	<!-- Style Manager -->
<?php }
if (JAK_ASACCESS && $jkv["styleswitcher_tpl"]) include_once APP_PATH . 'template/jakweb/styleswitcher.php'; ?>

<!-- Custom JS igrid -->
<script type="text/javascript"
	src="<?php echo BASE_URL; ?>template/jakweb/js/jakweb.js?=<?php echo $jkv["updatetime"]; ?>"></script>
