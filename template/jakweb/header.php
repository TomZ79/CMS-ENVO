...
<head>
  ...
  <?php if (JAK_ASACCESS && $jkv["styleswitcher_tpl"]) { ?>
    <link rel="stylesheet"
          href="<?php echo BASE_URL; ?>template/jakweb/css/stylechanger.css?=<?php echo $jkv["updatetime"]; ?>"
          type="text/css">
  <?php } ?>
...
<nav class="navbar navbar-default<?php if ($jkv["navbarstyle_jakweb_tpl"]) echo ' navbar-fixed-top'; ?> sb-slide">
  ...
  <div class="container">
    ...
    <div id="logo" class="navbar-left">
      <a href="<?php echo BASE_URL; ?>"><img src="<?php echo $jkv["logo_jakweb_tpl"]; ?>" alt="logo"
                                             id="main-logo"><span
