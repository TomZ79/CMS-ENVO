<?php if ($jkv["color_jakweb_tpl"] == "dark") { ?>
  <link rel="stylesheet"
        href="<?php echo BASE_URL; ?>template/jakweb/css/screendark.css?=<?php echo $jkv["updatetime"]; ?>"
        id="tpljakweb" type="text/css"/>
<?php } else { ?>
...
<?php if ($jkv["theme_jakweb_tpl"]) { ?>
  <link rel="stylesheet"
        href="<?php echo BASE_URL; ?>template/jakweb/css/themes/<?php echo $jkv["theme_jakweb_tpl"]; ?>.css?=<?php echo $jkv["updatetime"]; ?>"
        type="text/css" class="sctheme"/>
<?php } ?>

<?php if ($jkv["fontg_jakweb_tpl"] != "NonGoogle") { ?>
  <link rel="stylesheet"
        href="http://fonts.googleapis.com/css?family=<?php echo $jkv["fontg_jakweb_tpl"]; ?>:regular,italic,bold,bolditalic"
        type="text/css"/>
<?php } ?>

<style type="text/css">
  h1, h2, h3, h4, h5, h6 {
    font-family: <?php if ($jkv["fontg_jakweb_tpl"] != "NonGoogle") echo '"'.str_replace("+", " ", $jkv["fontg_jakweb_tpl"]).'", '; echo $jkv["font_jakweb_tpl"];?>;
  }

  body, code, input[type="text"], textarea {
    font-family: <?php echo $jkv["font_jakweb_tpl"];?>;
  }
