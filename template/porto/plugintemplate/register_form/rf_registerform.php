  ...
  <div class="row">
      ...
      <?php if (!ENVO_USERID) { ?>
        ...
        if (!isset($_SESSION["rf_msg_sent"]) || isset($_SESSION["rf_msg_sent"]) && $_SESSION["rf_msg_sent"] != 1) { ?>
          ...
          <form method="post" class="cFrom" action="<?php echo $_SERVER['REQUEST_URI']; ?>"
            ...
            <button type="submit" id="formsubmit" name="registerF"
              class="btn btn-primary pull-right"><?php echo $tl["contact"]["s"]; ?></button>
    ...
    <div class="col-md-6">
      <div class="basic-login">
        <?php if (!ENVO_USERID) { ?>
          ...
          <form role="form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
            ...
            <button type="submit" name="login"
              class="btn btn-primary btn-block"><?php echo $tl["general"]["g146"]; ?></button>
          </form>
        ...
        <?php } else { ?>
          <p><a href="<?php echo $P_USR_LOGOUT; ?>"
              class="btn btn-danger btn-block"><?php echo $tl["title"]["t6"]; ?></a></p>
        <?php } ?>
      </div>
    </div>
  </div>
