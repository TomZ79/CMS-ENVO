<?php
/*
 * PLUGIN DOWNLOAD - ALL VALUE for FRONTEND - wiki.php
 * ------------------------------------------------------------------
 *
 * Soubor slouží pro generovaní (zobrazení) celkového seznamu článků
 *
 * Použitelné hodnoty s daty pro FRONTEND - wiki.php
 * ------------------------------------------------------------------
 *
 * $ENVO_WIKI_ALL = pole s daty
 * foreach ($ENVO_WIKI_ALL as $v) = získání jednotlivých dat z pole
 *
...
if (ENVO_ASACCESS) $apedit = BASE_URL . 'admin/index.php?p=wiki&amp;sp=setting';
