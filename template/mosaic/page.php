<?php include_once APP_PATH.'template/mosaic/header.php';?>
		...
		<?php } ?>
		        ...
		        // Show Contact form
		        if ($pg["pluginid"] == '9997' && $JAK_SHOW_C_FORM) { include_once APP_PATH.'template/mosaic/contact.php'; }
		    ...
		    <!-- Show login form -->
		    <?php if ($PAGE_LOGIN_FORM) { include_once APP_PATH.'template/mosaic/loginpage.php'; } ?>
		    
		    <!-- Show vote result -->
		    <?php if ($SHOWVOTE && $USR_CAN_RATE) { include_once APP_PATH.'template/mosaic/voteresult.php'; } ?>
