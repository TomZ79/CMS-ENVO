...
<!-- Sidebar if right -->
<?php if (!empty($JAK_HOOK_SIDE_GRID) && $jkv["sidebar_location_tpl"] == "right") { include_once APP_PATH.'template/mosaic/sidebar.php'; } ?>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4" id="section-content">
				...
				} } } else { echo $jkv["bcontent1_mosaic_tpl"];}?>
			</div>
			<div class="col-md-4" id="section-content2">
				...
				} } } else { echo $jkv["bcontent2_mosaic_tpl"];}?>
			</div>
			<div class="col-md-4" id="section-content3">
				...
				} } } else { echo $jkv["bcontent3_mosaic_tpl"];}?>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container">
    	<div class="row">
    		<div class="col-footer col-sm-4">
    			...
    			<?php echo jak_build_menu(0, $mfooter, $page, 'footer-list-style footer-navigate-section', '', '', '', JAK_ASACCESS);?>
    			</div>
    		</div>
    	...
    	<div class="row">
    		...
    		<div class="col-sm-2">
    			...
    			<a class="btn btn-default btn-xs" href="javascript:void(0)" id="dispheatmap"><i class="fa fa-bar-chart"></i></a>
    			<?php } ?>
    			</div>
...
<!-- Style Manager -->
<?php } if (JAK_ASACCESS && $jkv["styleswitcher_tpl"]) include_once APP_PATH.'template/mosaic/styleswitcher.php';?>

<!-- Custom JS igrid -->
<script type="text/javascript" src="<?php echo BASE_URL;?>template/mosaic/js/mosaic.js?=<?php echo $jkv["updatetime"];?>"></script>
...
<script type="text/javascript" src="<?php echo BASE_URL;?>template/mosaic/js/stylechanger.js?=<?php echo $jkv["updatetime"];?>"></script>
<?php } ?>
