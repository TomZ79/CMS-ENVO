<?php include_once APP_PATH.'template/mosaic/header.php';?>
	...
	<?php } if (isset($PAGE_TITLE)) echo '<h1>'.$PAGE_TITLE .'</h1>'; if (isset($PAGE_CONTENT)) echo $PAGE_CONTENT;?>
		...
		<div class="input-group">
			<input type="text" name="jakSH" id="Jajaxs" class="form-control input-lg" placeholder="<?php echo $tl["search"]["s"]; if ($jkv["fulltextsearch"]) echo $tl["search"]["s5"];?>">
		      <span class="input-group-btn">
		        <button type="submit" class="btn btn-color btn-lg" name="search" id="JajaxSubmitSearch"><?php echo $tl["general"]["g83"];?></button>
		      </span>
		 </div><!-- /input-group -->
