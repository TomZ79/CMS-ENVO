		...
		<div class="jak-post">
			...
			<div class="post-info">
				<div class="info-details">
					<i class="fa fa-clock-o"></i> <?php echo $v["created"];?> <i class="fa fa-eye"></i> <?php echo $tl["general"]["g13"].$v["hits"];?>
				</div>
			</div>
			<!-- End Post Info -->
			<!-- Post Image -->
			...
			<div class="post-more">
				...
				<?php if (JAK_ASACCESS) { ?>
					...
					<a href="<?php echo BASE_URL;?>admin/index.php?p=news&amp;sp=edit&amp;id=<?php echo $v["id"];?>" title="<?php echo $tl["general"]["g"];?>" class="btn btn-default btn-sm jaktip"><i class="fa fa-pencil"></i></a>
					
					<a class="btn btn-default btn-sm jaktip quickedit" href="<?php echo BASE_URL;?>admin/index.php?p=news&amp;sp=quickedit&amp;id=<?php echo $v["id"];?>" title="<?php echo $tl["general"]["g176"];?>"><i class="fa fa-edit"></i></a>
