...
<head>
	...
	<style type="text/css">
		h1, h2, h3, h4, h5, h6 { font-family:<?php if ($jkv["fontg_mosaic_tpl"] != "NonGoogle") echo '"'.str_replace("+", " ", $jkv["fontg_mosaic_tpl"]).'", '; echo $jkv["font_mosaic_tpl"];?>; }
	</style>
	<style id="cFontStyles" type="text/css">
		body, code, input[type="text"], textarea { font-family:<?php echo $jkv["font_mosaic_tpl"];?>; }
	</style>
