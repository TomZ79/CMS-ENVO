<link rel="stylesheet" href="<?php echo BASE_URL;?>template/mosaic/css/ui-mosaic.css?=<?php echo $jkv["updatetime"];?>" type="text/css" />
<link rel="stylesheet" href="<?php echo BASE_URL;?>template/mosaic/css/themes/color-styles.css?=<?php echo $jkv["updatetime"];?>" type="text/css" />
<?php if ($jkv["design_mosaic_tpl"] == "dark") { ?>
<link rel="stylesheet" href="<?php echo BASE_URL;?>template/mosaic/css/dark.css?=<?php echo $jkv["updatetime"];?>" id="tplmosaic" type="text/css" />
<?php } else { ?>
<link rel="stylesheet" href="<?php echo BASE_URL;?>template/mosaic/css/screen.css?=<?php echo $jkv["updatetime"];?>" id="tplmosaic" type="text/css" />
<?php } ?>

<?php if ($jkv["fontg_mosaic_tpl"] != "NonGoogle") { ?>
<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=<?php echo $jkv["fontg_mosaic_tpl"];?>:regular,italic,bold,bolditalic" type="text/css" />
<?php } if ($jkv["font_mosaic_tpl"] == "Roboto") { ?>
<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=<?php echo $jkv["font_mosaic_tpl"];?>:regular,italic,bold,bolditalic" type="text/css" />
<?php } ?>

<style type="text/css">
	h1, h2, h3, h4, h5, h6 { font-family:<?php if ($jkv["fontg_mosaic_tpl"] != "NonGoogle") echo '"'.str_replace("+", " ", $jkv["fontg_mosaic_tpl"]).'", '; echo $jkv["font_mosaic_tpl"];?>, sans-serif; <?php echo ($jkv["hcolour_mosaic_tpl"] ? 'color:'.$jkv["hcolour_mosaic_tpl"].';' : '');?>}
	body, code, input[type="text"], textarea { font-family:<?php echo $jkv["font_mosaic_tpl"];?>, sans-serif; }
	...
	.boxed-layout {
		background-image: url("<?php echo BASE_URL;?>template/mosaic/img/patterns/<?php echo $jkv["boxpattern_mosaic_tpl"];?>.png");
	}
