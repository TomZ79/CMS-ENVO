<link rel="stylesheet"
	href="<?php echo BASE_URL; ?>template/mosaic/css/ui-mosaic.css?=<?php echo $jkv["updatetime"]; ?>"
	type="text/css"/>
<link rel="stylesheet"
	href="<?php echo BASE_URL; ?>template/mosaic/css/themes/color-styles.css?=<?php echo $jkv["updatetime"]; ?>"
	type="text/css"/>
<?php if ($jkv["design_mosaic_tpl"] == "dark") { ?>
	<link rel="stylesheet" href="<?php echo BASE_URL; ?>template/mosaic/css/dark.css?=<?php echo $jkv["updatetime"]; ?>"
