...
<head>
	...
	<!-- RTL Support -->
	<link rel="stylesheet" href="<?php echo BASE_URL;?>template/mosaic/css/rtlscreen.css?=<?php echo $jkv["updatetime"];?>" type="text/css" media="screen">
	<!-- End RTL Support -->
	<?php } ?>
	
	<?php if (JAK_ASACCESS && $jkv["styleswitcher_tpl"]) { ?>
	<link rel="stylesheet" href="<?php echo BASE_URL;?>template/mosaic/css/stylechanger.css?=<?php echo $jkv["updatetime"];?>" type="text/css">
	<?php } ?>
...
<body class="<?php echo $jkv["theme_mosaic_tpl"]; if ($JAK_SHOW_NAVBAR && $jkv["style_mosaic_tpl"] == "boxed") echo " boxed-layout container";?>">
...
<?php } ?>
	...
	<div class="container">
		<!-- Logo -->
		<div id="logo">
			<a href="<?php echo BASE_URL;?>"><img src="<?php echo $jkv["logo_mosaic_tpl"];?>" alt="logo" id="main-logo"><span class="sr-only"><?php echo $jkv["title"];?></span></a>
		</div><!-- /#logo -->
...
<div class="wrapper">
    <div class="topic">
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <h3 class="primary-font"><?php if ($page == "edit-profile") { echo sprintf($tl["login"]["l15"], $jakuser->getVar("username")); } else { echo $PAGE_TITLE;}?></h3>
          </div>
          <div class="col-sm-8">
