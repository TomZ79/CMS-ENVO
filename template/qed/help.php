...
&lt;i class=&quot;icon-heart large circle&quot;&gt;&lt;/i&gt;
      ...
      <article>
        ...
        <ul class="show-icon">
          ...
          <li><i class="icon-ok-circled"></i><span>icon-ok-circled</span></li>
          <li><i class="icon-mail-alt"></i><span>icon-mail-alt</span></li>
          <li><i class="icon-heart"></i><span>icon-heart</span></li>
          <li><i class="icon-ok-circled2"></i><span>icon-ok-circled2</span></li>
          <li><i class="icon-ok-squared"></i><span>icon-ok-squared</span></li>
          ...
          <li><i class="icon-cancel-circled2"></i><span>icon-cancel-circled2</span></li>
          ...
          <li><i class="icon-minus-squared-alt"></i><span>icon-minus-squared-alt</span></li>
          ...
          <li><i class="icon-flag-empty"></i><span>icon-flag-empty</span></li>
          <li><i class="icon-edit"></i><span>icon-edit</span></li>
          <li><i class="icon-doc-text"></i><span>icon-doc-text</span></li>
          <li><i class="icon-doc-inv"></i><span>icon-doc-inv</span></li>
          ...
          <li><i class="icon-thumbs-up-alt"></i><span>icon-thumbs-up-alt</span></li>
          <li><i class="icon-gamepad"></i><span>icon-gamepad</span></li>
          <li><i class="icon-folder-open"></i><span>icon-folder-open</span></li>
          <li><i class="icon-folder-empty"></i><span>icon-folder-empty</span></li>
          <li><i class="icon-comment-1"></i><span>icon-comment-1</span></li>
          <li><i class="icon-thumbs-down-alt"></i><span>icon-thumbs-down-alt</span></li>
          ...
          <li><i class="icon-folder-open-empty"></i><span>icon-folder-open-empty</span></li>
          <li><i class="icon-box"></i><span>icon-box</span></li>
          <li><i class="icon-comment-2"></i><span>icon-comment-2</span></li>
          <li><i class="icon-upload"></i><span>icon-upload</span></li>
          <li><i class="icon-link-ext-alt"></i><span>icon-link-ext-alt</span></li>
          <li><i class="icon-attach"></i><span>icon-attach</span></li>
          <li><i class="icon-download-cloud"></i><span>icon-download-cloud</span></li>
          <li><i class="icon-chat"></i><span>icon-chat</span></li>
          <li><i class="icon-rss"></i><span>icon-rss</span></li>
          <li><i class="icon-rss-squared"></i><span>icon-rss-squared</span></li>
          ...
          <li><i class="icon-lock-open-alt"></i><span>icon-lock-open-alt</span></li>
          <li><i class="icon-attention-alt"></i><span>icon-attention-alt</span></li>
          ...
          <li><i class="icon-pencil-squared"></i><span>icon-pencil-squared</span></li>
          <li><i class="icon-pencil"></i><span>icon-pencil</span></li>
          <li><i class="icon-export-alt"></i><span>icon-export-alt</span></li>
          ...
          <li><i class="icon-left-circled2"></i><span>icon-left-circled2</span></li>
          <li><i class="icon-right-circled2"></i><span>icon-right-circled2</span></li>
          ...
          <li><i class="icon-angle-circled-left"></i><span>icon-angle-circled-left</span></li>
          <li><i class="icon-angle-circled-right"></i><span>icon-angle-circled-right</span></li>
          <li><i class="icon-angle-circled-up"></i><span>icon-angle-circled-up</span></li>
          <li><i class="icon-angle-circled-down"></i><span>icon-angle-circled-down</span></li>
          ...
          <li><i class="icon-pound"></i><span>icon-pound</span></li>
          ...
          <li><i class="icon-ellipsis"></i><span>icon-ellipsis</span></li>
          ...
          <li><i class="icon-expand-right"></i><span>icon-expand-right</span></li>
          <li><i class="icon-collapse-left"></i><span>icon-collapse-left</span></li>
          ...
          <li><i class="icon-play-circled"></i><span>icon-play-circled</span></li>
          ...
          <li><i class="icon-sort-alt-up"></i><span>icon-sort-alt-up</span></li>
          ...
          <li><i class="icon-sort-alt-down"></i><span>icon-sort-alt-down</span></li>
          <li><i class="icon-frown"></i><span>icon-frown</span></li>
          <li><i class="icon-meh"></i><span>icon-meh</span></li>
          <li><i class="icon-sort-name-up"></i><span>icon-sort-name-up</span></li>
          ...
          <li><i class="icon-sort-name-down"></i><span>icon-sort-name-down</span></li>
          <li><i class="icon-anchor"></i><span>icon-anchor</span></li>
          <li><i class="icon-terminal"></i><span>icon-terminal</span></li>
          <li><i class="icon-sort-number-up"></i><span>icon-sort-number-up</span></li>
          ...
          <li><i class="icon-circle-empty"></i><span>icon-circle-empty</span></li>
          <li><i class="icon-dot-circled"></i><span>icon-dot-circled</span></li>
          <li><i class="icon-magic"></i><span>icon-magic</span></li>
          <li><i class="icon-truck"></i><span>icon-truck</span></li>
          <li><i class="icon-sort-number-down"></i><span>icon-sort-number-down</span></li>
          ...
          <li><i class="icon-extinguisher"></i><span>icon-extinguisher</span></li>
          ...
          <li><i class="icon-instagramm"></i><span>icon-instagramm</span></li>
          ...
          <li><i class="icon-xing-squared"></i><span>icon-xing-squared</span></li>
          ...
          <li><i class="icon-bitbucket-squared"></i><span>icon-bitbucket-squared</span></li>
          ...
          <li><i class="icon-facebook-squared"></i><span>icon-facebook-squared</span></li>
          ...
          <li><i class="icon-gplus-1"></i><span>icon-gplus-1</span></li>
