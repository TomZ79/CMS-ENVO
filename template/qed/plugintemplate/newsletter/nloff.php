    ...
    if (!JAK_USERID) {
      ...
      <div class="loginF">
        ...
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
          ...
          <button type="submit" name="login" class="btn btn-default"><?php echo $tl["button"]["btn4"]; ?></button>
        </form>
        <?php if ($errorlo) { ?>
      ...
      <div class="forgotP">
        ...
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
          ...
          <button type="submit" name="forgotP" class="btn btn-default"><?php echo $tl["button"]["btn4"]; ?></button>
        </form>
    ...
    <?php }
      ...
      <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
        <div class="form-group<?php if ($errorsnl) echo " has-error"; ?>">
          ...
          <div class="controls">
            <input type="text" class="form-control" name="nlEmail" id="nlEmail" value=""
              placeholder="<?php echo $tl["contact"]["c2"]; ?>"/>
          </div>
        </div>
        <button type="submit" name="nlOff" class="btn btn-default"><?php echo $tl["button"]["btn3"]; ?></button>
      </form>
