...
<?php }
if (isset($PAGE_TITLE)) echo '<h1>' . $PAGE_TITLE . '</h1>';
      ...
      <input type="text" name="jakSH" id="Jajaxs" class="form-control input-lg"
             ...
             if ($jkv["fulltextsearch"]) echo $tl["search"]["s5"]; ?>">
		      <span class="input-group-btn">
		        <button type="submit" class="btn btn-color btn-lg" name="search"
...
<?php if ($JAK_SEARCH_CLOUD) { ?>
  <hr>
  <div class="well well-sm"><?php echo $JAK_SEARCH_CLOUD; ?></div><?php } ?>
