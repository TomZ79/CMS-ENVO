...
// MENU BUILDER - MOBILE REPAIR, parentId 0 is the root
 ...
 *
 */
function build_menu_mobilerepair($parent, $menu, $maincategory, $active, $mainclass, $dropdown, $dropdownclass, $dropclass, $subclass, $admin)
{
  // Set global variable
  global $arr1;
  ...
  if (isset($menu['parents'][$parent])) {
    ...
    foreach ($menu['parents'][$parent] as $itemId) {
      ...
      if ($maincategory) {
        if (isset($menu['parents'][$itemId])) {
          ...
          $html .= build_menu_mobilerepair($itemId, $menu, $maincategory, $active, $dropclass, $subclass, $dropdownclass, $dropclass, $subclass, $admin);
    ...
    if ($admin) {
      $html .= '<li><a href="' . BASE_URL . 'admin/"> Admin Panel</a></li>';
    }
