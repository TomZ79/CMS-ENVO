...
<html lang="en">
<head>
  <title><?php echo $tl["uninstalltemplate"]["unitpl"] . ' - MOBILE REPAIR Template'; ?></title>
  <meta charset="utf-8">
  <!-- BEGIN Vendor CSS-->
  ...
  <div class="row">
    <div class="col-sm-12 m-t-20">
      <div class="jumbotron bg-master pt-1 pl-3 pb-1 pr-3">
        <h3 class="semi-bold text-white"><?php echo $tl["uninstalltemplate"]["unitpl"] . ' - MOBILE REPAIR Template'; ?></h3>
      </div>
      <hr>
