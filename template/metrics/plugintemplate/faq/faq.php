                  ...
                  <div id="collapse<?php echo $v["id"]; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading<?php echo $v["id"]; ?>">
                    <div class="panel-body">
                      ...
                      <div class="pull-right">
                        ...
                        <a href="<?php echo $v["parseurl"]; ?>" class="btn btn-primary btn-sm"><?php echo $tlf["faq_frontend"]["faq1"]; ?></a>

                        <?php if (JAK_ASACCESS) { ?>

                          <a href="<?php echo BASE_URL; ?>admin/index.php?p=faq&amp;sp=edit&amp;id=<?php echo $v["id"]; ?>" title="<?php echo $tl["button"]["btn1"]; ?>" class="btn btn-filled btn-primary btn-sm">
                            <span class="visible-xs"><i class="fa fa-edit"></i></span>
                            <span class="hidden-xs"><?php echo $tl["button"]["btn1"]; ?></span>
                          </a>
                          <a class="btn btn-filled btn-primary btn-sm quickedit" href="<?php echo BASE_URL; ?>admin/index.php?p=faq&amp;sp=quickedit&amp;id=<?php echo $v["id"]; ?>" title="<?php echo $tl["button"]["btn2"]; ?>">
