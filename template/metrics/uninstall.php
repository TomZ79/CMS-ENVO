...
<html lang="en">
<head>
	<title>Uninstallation - METRICS / Template</title>
	<meta charset="utf-8">
	<!-- BEGIN Vendor CSS-->
	...
	<div class="row">
		<div class="col-md-12 m-t-20">
			<div class="jumbotron bg-master">
				<h3 class="semi-bold text-white">Uninstallation - METRICS / Template</h3>
			</div>
			<hr>
			...
			<?php if (isset($_POST['uninstall'])) {
				...
				// Delete all settings
				$jakdb->query ('DELETE FROM ' . DB_PREFIX . 'setting WHERE product = "tpl_metrics"');

				// Delete php code for lang site from hooks
				$jakdb->query ('DELETE FROM ' . DB_PREFIX . 'pluginhooks WHERE product = "tpl_metrics"');
