 ...
 * Build menu
 */
function build_menu_metrics($parent, $menu, $maincategory, $active, $mainclass, $dropdown, $dropdownclass, $dropclass, $subclass, $admin)
{
  // Set global variable
  global $arr1;
    ...
    foreach ($menu['parents'][$parent] as $itemId) {
      ...
      if ($maincategory) {
        if (isset($menu['parents'][$itemId])) {
          ...
          $html .= build_menu_metrics($itemId, $menu, $maincategory, $active, $dropclass, $subclass, $dropdownclass, $dropclass, $subclass, $admin);
