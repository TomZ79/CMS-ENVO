        ...
        <div class="row-form">
          ...
          <div class="col-md-7">
            <div class="radio radio-success">
              ...
              echo $Html->addRadio('envo_programoffer', '1', ($JAK_FORM_DATA["programoffer"] == '1') ? TRUE : FALSE, 'envo_programoffer1');
              // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
              echo $Html->addLabel('envo_programoffer1', $tl["checkbox"]["chk"]);

              // Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
              echo $Html->addRadio('envo_programoffer', '0', ($JAK_FORM_DATA["programoffer"] == '0') ? TRUE : FALSE, 'envo_programoffer2');
              // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
