...
<html lang="en">
<head>
  <title>Update - Program Offer Plugin</title>
  <meta charset="utf-8">
  <!-- BEGIN Vendor CSS-->
  ...
  <div class="row">
    <div class="col-md-12 m-t-20">
      <div class="jumbotron bg-master">
        <h3 class="semi-bold text-white">Update - Program Offer Plugin</h3>
      </div>
      <hr>
      <div class="m-b-30">
        <h4 class="semi-bold">Program Offer Plugin - info about update to version <?php echo $pluginversion; ?></h4>
