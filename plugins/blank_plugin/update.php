...
<html lang="en">
<head>
	<title>Update - Blank Plugin</title>
	<meta charset="utf-8">
	<!-- BEGIN Vendor CSS-->
	<?php
	...
	<div class="row">
		<div class="col-md-12 m-t-20">
			<div class="jumbotron bg-master pt-1 pl-3 pb-1 pr-3">
				<h3 class="semi-bold text-white">Update - Blank Plugin</h3>
			</div>
			<hr>
			<div class="m-b-30">
				<h4 class="semi-bold">Blank Plugin - info about update to version <?= $pluginversion ?></h4>
