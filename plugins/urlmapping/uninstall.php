	...
	<div class="row">
		<div class="col-md-12 m-t-20">
			<div class="jumbotron bg-master">
				<h3 class="semi-bold text-white"><?php echo $tl["plugin"]["t31"]; ?></h3>
			</div>
			<hr>
			<div id="notificationcontainer"></div>
			<div class="m-b-30">
				<h4 class="semi-bold">URL Mapping Plugin - Info o odinstalačním procesu</h4>
				<p class="text-danger">
					<i class="fa fa-exclamation-triangle"></i>
					<span class="bold">POZOR: </span>
					<span class="semi-bold">Při odinstalování tohoto pluginu, budou odstraněny všechny uložené záznamy.</span>
				</p>
