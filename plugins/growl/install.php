  ...
  <div class="row">
    <div class="col-sm-12 m-t-20">
      ...
      <div class="m-b-30">
        ...
        <div data-pages="card" class="card card-transparent" id="card-basic">
          <div class="card-header separator">
            <div class="card-title"><?php echo $tlgwl["gwl_install"]["gwlinst2"]; ?></div>
      ...
      */
      ...
      $envodb->query('INSERT INTO ' . DB_PREFIX . 'plugins (`id`, `name`, `description`, `active`, `access`, `pluginorder`, `pluginpath`, `phpcode`, `phpcodeadmin`, `managenavhtml`, `usergroup`, `uninstallfile`, `pluginversion`, `time`) VALUES (NULL, "Growl", "Growl for your CMS.", 1, ' . ENVO_USERID . ', 4, "growl", "", "if ($page == \'growl\') {
