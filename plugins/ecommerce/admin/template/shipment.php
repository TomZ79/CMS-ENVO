        ...
        <table class="table table-striped">
          ...
          <?php foreach ($JAK_SHIPPING as $v) { ?>
            <tr>
              ...
              <td><a
                  href="index.php?p=shop&amp;sp=ecshipping&amp;ssp=edit&amp;sssp=<?php echo $v["id"]; ?>"><?php echo $v["title"]; ?></a>
              </td>
              <td style="width:200px"><?php echo $v["name"]; ?></td>
              <td style="width:200px"><?php echo $v["time"]; ?></td>
              <td style="width:100px"><?php echo $v["price"]; ?></td>
              <td><a href="index.php?p=shop&amp;sp=ecshipping&amp;ssp=lock&amp;sssp=<?php echo $v["id"]; ?>"><i
                    class="fa fa-<?php if ($v["status"] == 0) { ?>lock<?php } else { ?>check<?php } ?>"></i></a></td>
              <td><a href="index.php?p=shop&amp;sp=ecshipping&amp;ssp=edit&amp;sssp=<?php echo $v["id"]; ?>"
                     class="btn btn-default btn-xs"><i class="fa fa-edit"></i></a></td>
              <td><a href="index.php?p=shop&amp;sp=ecshipping&amp;ssp=delete&amp;sssp=<?php echo $v["id"]; ?>"
                     class="btn btn-default btn-xs"
                     onclick="if(!confirm('<?php echo $tlec["shop"]["al"]; ?>'))return false;"><i
