        ...
        <table class="table table-striped">
          <tr>
            <td><select name="jak_catid" class="form-control">
                <option
                  value="0"<?php if ($JAK_FORM_DATA["catid"] == '0') { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g19"]; ?></option>
            ...
            <td>
              <div class="input-group">
                <input type="text" name="jak_mimg" id="jak_mimg" class="form-control"
                       value="<?php echo $JAK_FORM_DATA["img"]; ?>"/>
		<span class="input-group-btn">
		  <a class="btn btn-info ifManager" type="button"
            ...
            <td>
              <div class="input-group">
                <input type="text" name="jak_file" id="jak_file" class="form-control"
                       value="<?php echo $JAK_FORM_DATA["digital_file"]; ?>"/>
		<span class="input-group-btn">
		  <a class="btn btn-info ifManager" type="button"
          ...
          <tr>
            ...
            <td><select name="jak_usergroup" class="form-control">
                ...
                <?php if (isset($JAK_USERGROUP_ALL) && is_array($JAK_USERGROUP_ALL)) foreach ($JAK_USERGROUP_ALL as $v) {
                  if ($v["id"] != "1") { ?>
                    <option value="<?php echo $v["id"]; ?>"<?php if ($v["id"] == $JAK_FORM_DATA["usergroup"]) { ?> selected="selected"<?php } ?>><?php echo $v["name"]; ?></option><?php }
                } ?>
              </select></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <div class="form-group<?php if (isset($errors["e2"])) echo " has-error"; ?>">
                <input type="text" class="form-control" name="jak_price"
                       value="<?php echo $JAK_FORM_DATA["price"]; ?>"/>
              </div>
            </td>
          </tr>
          <tr>
            <td><?php echo $tlec["shop"]["m46"]; ?></td>
            <td><input type="text" class="form-control" name="jak_sale" value="<?php echo $JAK_FORM_DATA["sale"]; ?>"/>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="input-group">
                <input type="text" name="jak_weight" class="form-control"
                       value="<?php echo $JAK_FORM_DATA["product_weight"]; ?>">
          ...
          <tr>
            ...
            <td>
              <div class="radio"><label><input type="radio" name="jak_stock"
                                               value="1"<?php if ($JAK_FORM_DATA["stock"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                </label></div>
              <div class="radio"><label><input type="radio" name="jak_stock"
                                               value="0"<?php if ($JAK_FORM_DATA["stock"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                </label></div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <input type="text" class="form-control" name="jak_poption"
                     value="<?php echo $JAK_FORM_DATA["product_options"]; ?>"/>
          ...
          <tr>
            ...
            <td>
              ...
              <input type="text" class="form-control" name="jak_poption1"
                     value="<?php echo $JAK_FORM_DATA["product_options1"]; ?>"/>
          ...
          <tr>
            ...
            <td>
              ...
              <input type="text" class="form-control" name="jak_poption2"
                     value="<?php echo $JAK_FORM_DATA["product_options2"]; ?>"/>
            ...
            <td>
              <?php if ($jkv["adv_editor"]) { ?>
                ...
                <textarea name="jak_content2" class="form-control hidden"
                          id="jak_editor2"><?php echo jak_edit_safe_userpost(htmlspecialchars($JAK_FORM_DATA["specs"])); ?></textarea>
              <?php } else { ?>
                <textarea name="jak_content2" class="form-control jakEditor" id="jakEditor2"
                          rows="40"><?php echo jak_edit_safe_userpost($JAK_FORM_DATA["specs"]); ?></textarea>
              <?php } ?>
            </td>
          </tr>
        </table>
