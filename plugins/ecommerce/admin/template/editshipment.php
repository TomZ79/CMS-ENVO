            ...
            <td>
              <div class="input-group">
                <input type="text" name="jak_img" id="jak_img" class="form-control"
                       value="<?php echo $JAK_FORM_DATA["jak_img"]; ?>"/>
      ...
      <div class="box-body">
        <table class="table table-striped">
          <tr>
            ...
            <td><input type="text" name="jak_estship" class="form-control"
                       value="<?php echo $JAK_FORM_DATA["est_shipping"]; ?>"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <div class="form-group<?php if (isset($errors["e3"])) echo " has-error"; ?>">
                <input type="text" name="jak_handling" class="form-control"
                       value="<?php echo $JAK_FORM_DATA["handling"]; ?>"/>
              </div>
            </td>
          </tr>
          <tr>
                  ...
                  <div class="col-md-6">
                    <div class="input-group">
                      <input type="text" name="jak_weight" class="form-control"
                             value="<?php echo $JAK_FORM_DATA["weightfrom"]; ?>">
                      <span class="input-group-addon"><?php echo $tlec["shop"]["m70"]; ?></span>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="input-group">
                      <input type="text" name="jak_weightto" class="form-control"
                             value="<?php echo $JAK_FORM_DATA["weightto"]; ?>">
                      <span class="input-group-addon"><?php echo $tlec["shop"]["m70"]; ?></span>
                    </div>
                  </div>
                </div>
