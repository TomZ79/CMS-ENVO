          ...
          <div class="box-body">
            <table class="table table-striped">
              ...
              <tr>
                ...
                <td><input class="form-control" type="text" name="jak_address"
                           value="<?php echo $jkv["e_shop_address"]; ?>"/></td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="form-group<?php if (isset($errors["e3"])) echo " has-error"; ?>">
                    <input type="text" name="jak_date" class="form-control"
                           value="<?php echo $jkv["shopdateformat"]; ?>"/>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="form-group<?php if (isset($errors["e4"])) echo " has-error"; ?>">
                    <input type="text" name="jak_time" class="form-control"
                           value="<?php echo $jkv["shoptimeformat"]; ?>"/>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="radio"><label><input type="radio" name="jak_shopurl"
                                                   value="1"<?php if ($jkv["shopurl"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_shopurl"
                                                   value="0"<?php if ($jkv["shopurl"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label></div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="radio"><label><input type="radio" name="jak_itemopen"
                                                   value="1"<?php if ($jkv["e_productopen"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_itemopen"
                                                   value="0"<?php if ($jkv["e_productopen"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label></div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="radio"><label><input type="radio" name="jak_checkout"
                                                   value="1"<?php if ($jkv["shopcheckout"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tlec["shop"]["m98"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_checkout"
                                                   value="2"<?php if ($jkv["shopcheckout"] == 2) { ?> checked="checked"<?php } ?> /> <?php echo $tlec["shop"]["m99"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_checkout"
                                                   value="3"<?php if ($jkv["shopcheckout"] == 3) { ?> checked="checked"<?php } ?> /> <?php echo $tlec["shop"]["m100"]; ?>
                    </label></div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><select name="jak_wcatid" class="form-control">
                    <option
                      value="0"<?php if (!$jkv["e_agreement"]) { ?> selected="selected"<?php } ?>><?php echo $tl["title"]["t12"]; ?></option>
                    <?php if (isset($JAK_CAT) && is_array($JAK_CAT)) foreach ($JAK_CAT as $c) {
                      if ($c["pluginid"] == '0' && $c["pageid"] > '0') { ?>
                        <option value="<?php echo $c["id"]; ?>"<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
                          if ($jkv["e_agreement"] == $c["id"]) { ?> selected="selected"<?php }
            ...
            <table class="table table-striped">
              ...
              <tr>
                ...
                <td><select name="jak_country" class="form-control">
                    <option
                      value="0"<?php if (!$jkv["e_country"]) { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g19"] . ' ' . $tlec["shop"]["m51"]; ?></option>
                    <?php echo $JAK_COUNTRY; ?>
                  </select></td>
              </tr>
              <tr>
                <td><?php echo $tlec["shop"]["m11"]; ?></td>
                <td><input type="text" name="jak_currency" class="form-control"
                           value="<?php echo $jkv["e_currency"]; ?>"/></td>
              </tr>
              <tr>
                <td><?php echo $tlec["shop"]["m12"]; ?> <a class="cms-help"
                                                           data-content="<?php echo $tlec["shop"]["m13"]; ?>"
                                                           href="javascript:void(0)"
                                                           data-original-title="<?php echo $tl["title"]["t21"]; ?>"><i
                      class="fa fa-question-circle"></i></a></td>
                <td><input type="text" name="jak_currency1" class="form-control"
                           value="<?php echo $jkv["e_currency1"]; ?>"/></td>
              </tr>
              <tr>
                <td><?php echo $tlec["shop"]["m12"]; ?> <a class="cms-help"
                                                           data-content="<?php echo $tlec["shop"]["m13"]; ?>"
                                                           ...
                                                           data-original-title="<?php echo $tl["title"]["t21"]; ?>"><i
                      class="fa fa-question-circle"></i></a></td>
                <td><input type="text" name="jak_currency2" class="form-control"
                           value="<?php echo $jkv["e_currency2"]; ?>"/></td>
              </tr>
            </table>
          </div>
          <div class="box-footer">
          ...
          <div class="box-body">
            <table class="table table-striped">
              <tr>
                ...
                <td><input class="form-control" type="text" name="jak_download"
                           value="<?php echo $jkv["e_shop_download"]; ?>"/></td>
              </tr>
              <tr>
                <td><?php echo $tlec["shop"]["m73"]; ?></td>
                <td><input class="form-control" type="text" name="jak_download_b"
                           value="<?php echo $jkv["e_shop_download_b"]; ?>"/></td>
              </tr>
              <tr>
                <td><?php echo $tlec["shop"]["m74"]; ?></td>
                <td><input class="form-control" type="text" name="jak_download_bt"
                           value="<?php echo $jkv["e_shop_download_bt"]; ?>"/></td>
              </tr>
            </table>
          </div>
          <div class="box-footer">
              ...
              <tr>
                <td>
                  <?php if ($jkv["adv_editor"]) { ?>
                    <p><a
                        href="../js/editor/plugins/filemanager/dialog.php?type=0&editor=mce_0&lang=eng&fldr=&field_id=csseditor"
                        class="btn btn-default btn-xs ifManager"><i class="fa fa-files-o"></i></a></p>
                    <div id="csseditor"></div>
                    <textarea name="jak_thankyou" class="form-control hidden"
                              id="jak_editor_ty"><?php echo jak_edit_safe_userpost(htmlspecialchars($jkv["e_thanks"])); ?></textarea>
                  <?php } else { ?>
                    <textarea name="jak_thankyou" class="jakEditorLight"
                              rows="4"><?php echo jak_edit_safe_userpost($jkv["e_thanks"]); ?></textarea>
                  <?php } ?>
                </td>
              </tr>
            </table>
                ...
                <td>
                  <div class="<?php if (isset($errors["e5"])) echo " has-error"; ?>">
                    <select name="jak_mid" class="form-control selectpicker">
                      <option value="2"<?php if ($jkv["shoppagemid"] == 2) { ?> selected="selected"<?php } ?>>
                        Range 1 page
                      </option>
                      <option value="4"<?php if ($jkv["shoppagemid"] == 4) { ?> selected="selected"<?php } ?>>
                        Range 2 page
                      </option>
                      <option value="6"<?php if ($jkv["shoppagemid"] == 6) { ?> selected="selected"<?php } ?>>
                        Range 3 page
                      </option>
                      <option value="8"<?php if ($jkv["shoppagemid"] == 8) { ?> selected="selected"<?php } ?>>
                        Range 4 page
                      </option>
                      <option value="10"<?php if ($jkv["shoppagemid"] == 10) { ?> selected="selected"<?php } ?>>
                        Range 5 page
                      </option>
                    </select>
                  </div>
                ...
                <td>
                  <div class="form-group<?php if (isset($errors["e5"])) echo " has-error"; ?>">
                    <input type="text" name="jak_item" class="form-control"
                           value="<?php echo $jkv["shoppageitem"]; ?>"/>
                  </div>
                </td>
              </tr>
            </table>
