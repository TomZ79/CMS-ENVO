...
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . '/config.php')) die('[' . __DIR__ . '/udpate.php] => "config.php" not found');
...
<html lang="en">
<head>
  <title>Update - Blog Plugin</title>
  <meta charset="utf-8">
  <!-- BEGIN Vendor CSS-->
  ...
  <div class="row">
    <div class="col-md-12 m-t-20">
      <div class="jumbotron bg-master">
        <h3 class="semi-bold text-white">Update - Blog Plugin</h3>
      </div>
      <hr>
      <div class="m-b-30">
        <h4 class="semi-bold">Blog Plugin - info about update to version <?php echo $pluginversion; ?></h4>
