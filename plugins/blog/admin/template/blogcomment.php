          ...
          <table class="table table-striped table-hover">
            ...
            <?php foreach ($JAK_BLOGCOM_ALL as $v) { ?>
              <tr>
                ...
                <td>
                  <a href="index.php?p=blog&amp;sp=comment&amp;ssp=delete&amp;sssp=<?php echo $v["id"]; ?>" class="btn btn-default btn-xs" data-confirm="<?php echo $tlblog["blog"]["co"]; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $tl["icons"]["i1"]; ?>">
