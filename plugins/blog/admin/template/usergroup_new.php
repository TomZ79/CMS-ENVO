  ...
  <div class="box-body">
    <table class="table table-striped">
      <tr>
        ...
        <td>
          <div class="radio"><label><input type="radio" name="jak_blog" value="1"<?php if (!$JAK_FORM_DATA) {
                if ($_REQUEST["jak_blog"] == '1') { ?> checked="checked"<?php }
              } else {
                if ($JAK_FORM_DATA["blog"] == '1') { ?> checked="checked"<?php }
              } ?> /> <?php echo $tl["general"]["g18"]; ?></label></div>
          <div class="radio"><label><input type="radio" name="jak_blog" value="0"<?php if (!$JAK_FORM_DATA) {
      ...
      <tr>
        ...
        <td>
          <div class="radio"><label><input type="radio" name="jak_blogpost" value="1"<?php if (!$JAK_FORM_DATA) {
                if ($_REQUEST["jak_blogpost"] == '1') { ?> checked="checked"<?php }
              } else {
                if ($JAK_FORM_DATA["blogpost"] == '1') { ?> checked="checked"<?php }
              } ?> /> <?php echo $tl["general"]["g18"]; ?></label></div>
          <div class="radio"><label><input type="radio" name="jak_blogpost" value="0"<?php if (!$JAK_FORM_DATA) {
      ...
      <tr>
        ...
        <td>
          <div class="radio"><label><input type="radio" name="jak_blogpostapprove" value="0"<?php if (!$JAK_FORM_DATA) {
                if ($_REQUEST["jak_blogpostapprove"] == '0') { ?> checked="checked"<?php }
              } else {
                if ($JAK_FORM_DATA["blogpostapprove"] == '0') { ?> checked="checked"<?php }
              } ?> /> <?php echo $tl["general"]["g18"]; ?></label></div>
          <div class="radio"><label><input type="radio" name="jak_blogpostapprove" value="1"<?php if (!$JAK_FORM_DATA) {
      ...
      <tr>
        ...
        <td>
          <div class="radio"><label><input type="radio" name="jak_blogpostdelete" value="1"<?php if (!$JAK_FORM_DATA) {
                if ($_REQUEST["jak_blogpostdelete"] == '1') { ?> checked="checked"<?php }
              } else {
                if ($JAK_FORM_DATA["blogpostdelete"] == '1') { ?> checked="checked"<?php }
              } ?> /> <?php echo $tl["general"]["g18"]; ?></label></div>
          <div class="radio"><label><input type="radio" name="jak_blogpostdelete" value="0"<?php if (!$JAK_FORM_DATA) {
      ...
      <tr>
        ...
        <td>
          <div class="radio"><label><input type="radio" name="jak_blograte" value="1"<?php if (!$JAK_FORM_DATA) {
                if ($_REQUEST["jak_blograte"] == '1') { ?> checked="checked"<?php }
              } else {
                if ($JAK_FORM_DATA["blograte"] == '1') { ?> checked="checked"<?php }
              } ?> /> <?php echo $tl["general"]["g18"]; ?></label></div>
          <div class="radio"><label><input type="radio" name="jak_blograte" value="0"<?php if (!$JAK_FORM_DATA) {
      ...
      <tr>
        ...
        <td>
          <div class="radio"><label><input type="radio" name="jak_blogmoderate" value="1"<?php if (!$JAK_FORM_DATA) {
                if ($_REQUEST["jak_blogmoderate"] == '1') { ?> checked="checked"<?php }
              } else {
                if ($JAK_FORM_DATA["blogmoderate"] == '1') { ?> checked="checked"<?php }
              } ?> /> <?php echo $tl["general"]["g18"]; ?></label></div>
          <div class="radio"><label><input type="radio" name="jak_blogmoderate" value="0"<?php if (!$JAK_FORM_DATA) {
