      ...
      <div class="block-content">
          ...
          <div class="col-md-7">
            <div class="radio">
              <label class="checkbox-inline">
                <input type="radio" name="jak_blog" value="1"<?php if (!$JAK_FORM_DATA) {
                  if ($_REQUEST["jak_blog"] == '1') { ?> checked="checked"<?php }
                } else {
                  if ($JAK_FORM_DATA["blog"] == '1') { ?> checked="checked"<?php }
                } ?> /> <?php echo $tl["general"]["g18"]; ?>
              </label>
              <label class="checkbox-inline"><input type="radio" name="jak_blog" value="0"<?php if (!$JAK_FORM_DATA) {
        ...
        <div class="row-form">
          ...
          <div class="col-md-7">
            <div class="radio">
              <label class="checkbox-inline">
                <input type="radio" name="jak_blogpost" value="1"<?php if (!$JAK_FORM_DATA) {
              ...
              <label class="checkbox-inline">
                <input type="radio" name="jak_blogpost" value="0"<?php if (!$JAK_FORM_DATA) {
        ...
        <div class="row-form">
          ...
          <div class="col-md-7">
            <div class="radio">
              <label class="checkbox-inline">
                <input type="radio" name="jak_blogpostapprove" value="0"<?php if (!$JAK_FORM_DATA) {
              ...
              <label class="checkbox-inline">
                <input type="radio" name="jak_blogpostapprove" value="1"<?php if (!$JAK_FORM_DATA) {
        ...
        <div class="row-form">
          ...
          <div class="col-md-7">
            <div class="radio">
              <label class="checkbox-inline">
                <input type="radio" name="jak_blogpostdelete" value="1"<?php if (!$JAK_FORM_DATA) {
              ...
              <label class="checkbox-inline">
                <input type="radio" name="jak_blogpostdelete" value="0"<?php if (!$JAK_FORM_DATA) {
        ...
        <div class="row-form">
          ...
          <div class="col-md-7">
            <div class="radio">
              <label class="checkbox-inline">
                <input type="radio" name="jak_blograte" value="1"<?php if (!$JAK_FORM_DATA) {
              ...
              <label class="checkbox-inline">
                <input type="radio" name="jak_blograte" value="0"<?php if (!$JAK_FORM_DATA) {
        ...
        <div class="row-form">
          ...
          <div class="col-md-7">
            <div class="radio">
              <label class="checkbox-inline">
                <input type="radio" name="jak_blogmoderate" value="1"<?php if (!$JAK_FORM_DATA) {
              ...
              <label class="checkbox-inline">
                <input type="radio" name="jak_blogmoderate" value="0"<?php if (!$JAK_FORM_DATA) {
