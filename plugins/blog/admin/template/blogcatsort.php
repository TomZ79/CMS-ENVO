          ...
          <table class="table table-striped table-hover">
            ...
            <?php if (isset($JAK_BLOG_SORT) && is_array($JAK_BLOG_SORT)) foreach ($JAK_BLOG_SORT as $v) { ?>
              <tr>
                ...
                <td>
                  <a href="index.php?p=blog&amp;sp=delete&amp;ssp=<?php echo $v["id"]; ?>" class="btn btn-default btn-xs" onclick="if(!confirm('<?php echo $tl["page"]["al"]; ?>'))return false;" data-toggle="tooltip" data-placement="bottom" title="<?php echo $tl["icons"]["i1"]; ?>">
