              ...
              <div class="box-body">
                <div class="block">
                  <div class="block-content">
                    ...
                    <div class="row-form">
                      <div class="col-md-5"><strong><?php echo $tlblog["blog_box_content"]["blogbc9"]; ?> / <?php echo $tlblog["blog_box_content"]["blogbc10"]; ?></strong></div>
                      <div class="col-md-7">
            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <div class="block">
                  <div class="block-content">
                    <div class="row-form">
                      <div class="col-md-6"><strong><?php echo $tlblog["blog_box_content"]["blogbc11"]; ?></strong></div>
                      <div class="col-md-6">
                    ...
                    <div class="row-form">
                      <div class="col-md-6"><strong><?php echo $tlblog["blog_box_content"]["blogbc12"]; ?></strong></div>
                      <div class="col-md-6">
