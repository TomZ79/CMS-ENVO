          ...
          <div class="box-body">
            <table class="table table-striped">
              ...
              <tr>
                ...
                <td>
                  <div class="radio"><label><input type="radio" name="jak_uploadc"
                                                   value="1"<?php if (isset($_REQUEST["jak_uploadc"]) && $_REQUEST["jak_uploadc"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_uploadc"
                                                   value="0"<?php if (isset($_REQUEST["jak_uploadc"]) && $_REQUEST["jak_uploadc"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label></div>
                </td>
              </tr>
              <tr>
