            ...
            <table class="table table-striped first-column v-text-center">
              ...
              <tr>
                ...
                <td>
                  <div class="radio">
                    <label class="checkbox-inline">
                      <input type="radio" name="jak_uploadc" value="1"<?php if (isset($_REQUEST["jak_uploadc"]) && $_REQUEST["jak_uploadc"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label>
                    <label class="checkbox-inline">
                      <input type="radio" name="jak_uploadc" value="0"<?php if (isset($_REQUEST["jak_uploadc"]) && $_REQUEST["jak_uploadc"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label>
                  </div>
                </td>
              </tr>
