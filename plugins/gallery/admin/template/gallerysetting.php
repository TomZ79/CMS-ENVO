...
<?php } if ($errors) { ?>
  <script type="text/javascript">
    ...
    setTimeout(function() {
      $.notify({
        // options
        message: '<?php if (isset($errors["e1"])) echo $errors["e1"];
                    ...
                    <td>
                      <div class="<?php if (isset($errors["e5"])) echo " has-error"; ?>">
                        <select name="jak_mid" class="form-control selectpicker">
                          <option value="2"<?php if ($jkv["gallerypagemid"] == 2) { ?> selected="selected"<?php } ?>>
                            Range 1 page
                          </option>
                          <option value="4"<?php if ($jkv["gallerypagemid"] == 4) { ?> selected="selected"<?php } ?>>
                            Range 2 page
                          </option>
                          <option value="6"<?php if ($jkv["gallerypagemid"] == 6) { ?> selected="selected"<?php } ?>>
                            Range 3 page
                          </option>
                          <option value="8"<?php if ($jkv["gallerypagemid"] == 8) { ?> selected="selected"<?php } ?>>
                            Range 4 page
                          </option>
                          <option value="10"<?php if ($jkv["gallerypagemid"] == 10) { ?> selected="selected"<?php } ?>>
                            Range 5 page
                          </option>
                        </select>
                      </div>
