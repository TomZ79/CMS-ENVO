      ...
      <div class="row" style="height: <?php echo $jkv["gallerythumbh"] + 20; ?>px;">
        <div id="gallery_plugin_rotator" class="col-xs-12">
          <?php foreach ($JAK_GALLERY_FOOTER as $galfw) { ?>
            <a href="<?php echo $galfw["parseurl"]; ?>"><img
                src="<?php echo BASE_URL; ?>plugins/gallery/upload<?php echo $galfw["paththumb"]; ?>"
                class="img-thumbnail img-responsive" alt="<?php echo $galfw["title"]; ?>"/></a>
          <?php } ?>
        </div>
      </div>
      ...
      <div class="row" style="height: <?php echo $jkv["gallerythumbh"] + 20; ?>px;">
        ...
        <div id="gallery_plugin_rotator2" class="col-xs-6">
          <?php foreach ($JAK_GALLERY_FOOTER2 as $galfw2) { ?>
            <a href="<?php echo $galfw2["parseurl"]; ?>"><img
                src="<?php echo BASE_URL; ?>plugins/gallery/upload<?php echo $galfw2["paththumb"]; ?>"
                class="img-thumbnail img-responsive" alt="<?php echo $galfw2["title"]; ?>"/></a>
          <?php } ?>
        </div>
      </div>
