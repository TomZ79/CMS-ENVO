								...
								<div class="row-form">
									...
									<div class="col-sm-3">
										<div class="form-group m-0<?php if (isset($errors["e1"]) || isset($errors["e3"])) echo " has-error"; ?>">
											...
											echo $Html -> addInput('text', 'envo_sids', (isset($_REQUEST["envo_sids"]) ? $_REQUEST["envo_sids"] : ''), '', 'form-control');
											?>
									...
									<div class="col-sm-3">
										...
										<?php
										// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
										echo $Html -> addTag('strong', 'Název Ostatní Služby');
										?>
									...
									<div class="col-sm-3">
										<div class="form-group m-0<?php if (isset($errors["e2"])) echo " has-error"; ?>">
											...
											<?php
											// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
											echo $Html -> addInput('text', 'envo_sidsname', (isset($_REQUEST["envo_sidsname"]) ? $_REQUEST["envo_sidsname"] : ''), '', 'form-control');
											?>
