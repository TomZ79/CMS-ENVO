                ...
                <div class="row-form">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group no-margin<?php if (isset($errors["e1"]) || isset($errors["e3"])) echo " has-error"; ?>">
                      ...
                      echo $Html->addInput('text', 'envo_sidr', (isset($_REQUEST["envo_sidr"]) ? $_REQUEST["envo_sidr"] : ''), '', 'form-control');
                      ?>
                  ...
                  <div class="col-sm-3">
                    ...
                    <?php
                    // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
                    echo $Html->addTag('strong', 'Název Rozhlasového Programu');
                    ?>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group no-margin<?php if (isset($errors["e2"])) echo " has-error"; ?>">
                      ...
                      <?php
                      // Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
                      echo $Html->addInput('text', 'envo_sidrname', (isset($_REQUEST["envo_sidrname"]) ? $_REQUEST["envo_sidrname"] : ''), '', 'form-control');
                      ?>
