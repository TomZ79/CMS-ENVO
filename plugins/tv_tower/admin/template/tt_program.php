          ...
          <?php foreach ($ENVO_TVPROGRAM_ALL as $tp) { ?>
            <tr>
              ...
              <td class="text-center">
                ...
                <?php
                // Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
                echo $Html->addAnchor('index.php?p=tv-tower&amp;sp=tvprogram&amp;ssp=editprogram&amp;id=' . $tp["id"], '<i class="fa fa-edit"></i>', '', 'btn btn-default btn-xs', array('data-toggle' => 'tooltipEnvo', 'title' => $tl["icons"]["i2"]));
                ?>
