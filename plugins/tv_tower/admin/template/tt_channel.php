          ...
          <?php foreach ($JAK_TVCHANNEL_ALL as $tc) { ?>
            <tr>
              ...
              <td class="text-center">
                ...
                <?php
                // Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
                echo $Html->addAnchor('index.php?p=tv-tower&amp;sp=tvprogram&amp;ssp=newprogram&amp;value=' . $tc["towerid"] . '-' . $tc["id"] . '-' . $tc["number"] , '<i class="fa fa-sticky-note-o"></i>', '', 'btn btn-default btn-xs m-r-20', array('data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => $tl["icons"]["i2"]));

                echo $Html->addAnchor('index.php?p=tv-tower&amp;sp=tvchannel&amp;ssp=editchannel&amp;id=' . $tc["id"], '<i class="fa fa-edit"></i>', '', 'btn btn-default btn-xs m-r-20', array('data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => $tl["icons"]["i2"]));

                echo $Html->addAnchor('index.php?p=tv-tower&amp;sp=tvchannel&amp;ssp=delete&amp;id=' . $tc["id"], '<i class="fa fa-trash-o"></i>', '', 'btn btn-danger btn-xs', array('data-confirm' => sprintf($tltt["tt_notification"]["deltvtower"], $tc["number"] . 'K'), 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => $tl["icons"]["i1"]));
                ?>
