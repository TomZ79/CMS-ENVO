								...
								<div class="row-form">
									...
									<div class="col-sm-3">
										<div class="form-group m-0<?php if (isset($errors["e1"]) || isset($errors["e3"])) echo " has-error"; ?>">
											...
											echo $Html -> addInput('text', 'envo_sidtv', (isset($_REQUEST["envo_sidtv"]) ? $_REQUEST["envo_sidtv"] : ''), '', 'form-control');
											?>
									...
									<div class="col-sm-3">
										<div class="form-group m-0<?php if (isset($errors["e2"])) echo " has-error"; ?>">
											...
											<?php
											// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
											echo $Html -> addInput('text', 'envo_sidtvname', (isset($_REQUEST["envo_sidtvname"]) ? $_REQUEST["envo_sidtvname"] : ''), '', 'form-control');
											?>
