    ...
    <div class="row tvtower">
      <div class="col-md-12">
        <div class="text-center">
          <h4>V Karlovarském kraji lze přijímat programy z <span style="font-weight: bold;font-size: 25px;"><?php echo $COUNT_TVTOWER_ALL; ?></span> vysílačů</h4>
        </div>
        <hr>
      </div>
      <div class="col-md-12">
        <div class="col-md-4 text-center">
          ...
          <div class="text">
            <h3 class="title"><?php echo $tltt["tt_frontend_mainpage"]["ttmp"]; ?></h3>
            <div class="description">Vyberte si ze všech programů jen ty, které si potřebujete naladit na Vaší TV</div>
          </div>
          <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-sm-10 col-sm-offset-1">
              <a href="/programova-nabidka/wizard" class="btn btn-info btn-block" style="width: 100%;margin-bottom:50px;"><?php echo $tltt["tt_frontend_mainpage"]["ttmp1"]; ?></a>
            </div>
          </div>
        ...
        <div class="col-md-4 text-center">
          ...
          <div class="text">
            <h3 class="title"><?php echo $tltt["tt_frontend_mainpage"]["ttmp2"]; ?></h3>
