						...
						<table class="table no-border">
							<tr>
								<td class="form-inline">
									...
									<input type="text" name="envo_xmlseopath" id="folder" value="<?= $XMLSEOPATH ?>" class="form-control m-l-10 m-r-10"/>
									sitemap.xml
								</td>
							</tr>
						</table>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="form-group">
							...
							<textarea id="envo_filetxt" name="envo_filetxt" rows="8" placeholder="<?= $tlxml["xml_box_content"]["xmlbc6"] ?>" class="form-control m-t-10"><?= htmlspecialchars($content) ?></textarea>
						</div>
						<div>
