		...
		<aside class="nav-side-menu">
			...
			<div class="menu-list">
				<ul class="menu-content collapse" id="faqsidebar">
					<?php if (isset($ENVO_FAQ_CAT) && is_array($ENVO_FAQ_CAT)) foreach ($ENVO_FAQ_CAT as $c) { ?><?php if ($c["catparent"] == 0) { ?>
						...
						?> >
							...
							<ul>
								<?php if (isset($ENVO_FAQ_CAT) && is_array($ENVO_FAQ_CAT)) foreach ($ENVO_FAQ_CAT as $c1) { ?><?php if ($c1["catparent"] != '0' && $c1["catparent"] == $c["id"]) { ?>
									<li>
