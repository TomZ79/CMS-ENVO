					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1"
								href="#collapse<?php echo $v["id"]; ?>"><i class="fa fa-eye"></i></a>
						...
						<div id="collapse<?php echo $v["id"]; ?>" class="accordion-body collapse">
							<div class="accordion-inner">
								...
								<div class="pull-right">
									<?php if (JAK_ASACCESS) { ?>
										<a href="<?php echo BASE_URL; ?>admin/index.php?p=faq&amp;sp=edit&amp;id=<?php echo $v["id"]; ?>"
											title="<?php echo $tl["general"]["g"]; ?>" class="btn btn-default btn-xs jaktip"><i
												class="fa fa-pencil"></i></a>
										<a class="btn btn-default btn-xs jaktip quickedit"
											href="<?php echo BASE_URL; ?>admin/index.php?p=faq&amp;sp=quickedit&amp;id=<?php echo $v["id"]; ?>"
