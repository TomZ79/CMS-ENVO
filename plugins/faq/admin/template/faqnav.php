<li class="treeview<?php if ($page == 'faq' || $page == 'faq' && in_array($page1, array("new", "categories", "newcategory", "subcategories", "categories", "comment", "trash", "setting")) || $page == 'faq' && $page1 == 'categories' && $page2 == 'edit') echo ' active'; ?>">
  <a href="javascript:void(0)">
    <i class="fa fa-question-circle"></i> <?php echo $tlf["faq"]["m"]; ?> <i class="fa fa-angle-left pull-right"></i>
  </a>
  ...
  <ul class="treeview-menu">
    ...
    <?php if ($page == 'faq' && $page1 == 'subcategories') { ?>
      <li class="active">
        <a href="index.php?p=faq&amp;sp=subcategories&amp;ssp=<?php echo $page2; ?>">
