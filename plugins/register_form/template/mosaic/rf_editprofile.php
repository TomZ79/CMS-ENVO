		...
		<div class="col-md-6">
            ...
            <span class="btn btn-default btn-file"><span class="fileinput-new"><?php echo $tl["login"]["l12"]; ?></span><span
				...
				<div class="row text-center">
					<div class="col-xs-2">
						<img src="../<?php echo JAK_FILES_DIRECTORY; ?>/userfiles/standard.png" class="img-responsive"
							alt="standard avatar"/>
					...
					<div class="col-xs-2">
						<img src="../<?php echo JAK_FILES_DIRECTORY; ?>/userfiles/avatar2.png" class="img-responsive"
							alt="avatar2"/>
						<div class="radio"><label><input type="radio" name="avatar"
					...
					<div class="col-xs-2">
						<img src="../<?php echo JAK_FILES_DIRECTORY; ?>/userfiles/avatar3.png" class="img-responsive"
							alt="avatar3"/>
						<div class="radio"><label><input type="radio" name="avatar"
					...
					<div class="col-xs-2">
						<img src="../<?php echo JAK_FILES_DIRECTORY; ?>/userfiles/avatar4.png" class="img-responsive"
							alt="avatar4"/>
						<div class="radio"><label><input type="radio" name="avatar"
