<?php if ($jkv["showloginside"]) { ?>
  <aside class="sidebar">
    <?php if (!JAK_USERID) {
      ...
      <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
        ...
        <div class="form-group">
          ...
          <button type="submit" name="login"
                  class="btn btn-success pull-right"><?php echo $tl["general"]["g146"]; ?></button>
      ...
      <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
        ...
        <button type="submit" name="forgotP"
                class="btn btn-warning pull-right"><?php echo $tl["general"]["g178"]; ?></button>
        <div class="clearfix"></div>
      </form>
    ...
    <?php } else { ?>
      ...
      <p><a href="<?php echo $P_USR_LOGOUT; ?>" class="btn btn-danger pull-right"><?php echo $tl["title"]["t6"]; ?></a>
      </p>
      <div class="clearfix"></div>
    <?php } ?>
  </aside>
