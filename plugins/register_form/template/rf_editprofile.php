    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="tabs tabs-bottom tabs-center tabs-simple">
        <ul class="nav nav-tabs">
          <li class="active">
            <a href="#tabsNavigationSimple1" data-toggle="tab"><?php echo $tlrf["rf_frontend"]["rf11"]; ?></a>
          </li>
          <li>
            <a href="#tabsNavigationSimple2" data-toggle="tab"><?php echo $tlrf["rf_frontend"]["rf12"]; ?></a>
          </li>
          <li>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tabsNavigationSimple1">
            ...
            <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <input type="submit" value="<?php echo $tlrf["rf_frontend_button"]["btn"]; ?>" class="btn btn-primary pull-right" id="stuffR" name="stuffR">
                </div>
              </div>
            </form>
          </div>
            ...
            <div id="pwd-container">
              <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <input type="submit" value="<?php echo $tlrf["rf_frontend_button"]["btn"]; ?>" class="btn btn-primary pull-right" id="email_passR" name="email_passR">
                  </div>
                </div>
              </form>
            </div>
          ...
          <div class="tab-pane" id="tabsNavigationSimple3">
            ...
            <span class="btn btn-default btn-file"><span class="fileinput-new"><?php echo $tl["login"]["l12"]; ?></span><span
                ...
                <input type="submit" value="<?php echo $tlrf["rf_frontend_button"]["btn"]; ?>" class="btn btn-primary pull-right" id="avatarR" name="avatarR">
              </div>
              <div class="row">
                <h4 class="heading-primary text-uppercase mb-md">
                ...
                <input type="submit" value="<?php echo $tlrf["rf_frontend_button"]["btn"]; ?>" class="btn btn-primary pull-right" id="avatarS" name="avatarS">
              </div>
            </form>
