            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <?php echo $tl["cform"]["c8"]; ?> <input type="text" class="form-control jakread" readonly="readonly"
                                                         value="female,male" name="jak_options[]">
              </div>
              <div class="col-md-2">
          ...
          <?php if (isset($JAK_REGISTEROPTION_ALL) && is_array($JAK_REGISTEROPTION_ALL)) foreach ($JAK_REGISTEROPTION_ALL as $o) { ?>
            ...
            <li class="jakcform">
              <div class="row">
                ...
                <div class="col-md-3">
                  <?php echo $tl["cform"]["c8"]; ?> <input type="text" name="jak_options_old[]" class="form-control"
                                                           value="<?php echo $o["options"]; ?>"
                                                           placeholder="<?php echo $lrf["register"]["r14"]; ?>">
                </div>
                <div class="col-md-2">
                  <?php echo $tl["cform"]["c9"]; ?> <select name="jak_optionmandatory_old[]" class="form-control">
                    ...
                    <option
                      value="4"<?php if ($o["mandatory"] == 4) { ?> selected="selected"<?php } ?>><?php echo $lrf["register"]["r11"]; ?></option>
                    <option
                      value="5"<?php if ($o["mandatory"] == 5) { ?> selected="selected"<?php } ?>><?php echo $lrf["register"]["r13"]; ?></option>
                  </select>
                </div>
                <div class="col-md-1">
                  <i class="fa fa-user-plus"></i> <select name="jak_showregister[]" class="form-control">
                    <option
                      value="0"<?php if ($o["showregister"] == 0) { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g19"]; ?></option>
                    <option
                      value="1"<?php if ($o["showregister"] == 1) { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g18"]; ?></option>
                  </select>
                </div>
                <div class="col-md-1">
                  <?php if ($o["id"] > 3) { ?>
