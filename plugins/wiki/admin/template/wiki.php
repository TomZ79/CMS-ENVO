							...
							<tr>
								...
								<td>
									...
									if ($v["active"] == 1 && $v["catid"] != 0) { // Odemčeno a není Archiv
										echo $tlw["wiki_box_content"]["wikibc20"]; // Aktivní
									} elseif ($v["active"] == 1 && $v["catid"] == 0) { // Odemčeno a je Archiv
										echo $tlw["wiki_box_content"]["wikibc21"] . '<span class="small">  - ' . $tlw["wiki_box_content"]["wikibc22"] . '</span>'; // Neaktivní - Archiv
									} elseif ($v["active"] == 0 && $v["catid"] != 0) { // Uzamčeno a není Archiv
										echo $tlw["wiki_box_content"]["wikibc21"] . '<span class="small">  - ' . $tlw["wiki_box_content"]["wikibc23"] . '</span>'; // Neaktivní -  Uzamčeno
									} else { //Uzamčeno a je Archiv
										echo $tlw["wiki_box_content"]["wikibc21"] . '<span class="small">  - ' . $tlw["wiki_box_content"]["wikibc23"] . ', ' . $tlw["wiki_box_content"]["wikibc22"] . '</span>'; // Neaktivní -  Uzamčeno, Archiv
									}
									?>
