...
<?php if (isset($ENVO_WIKI_CAT_EXIST)) { ?>
  ...
  <div class="box box-success">
    <div class="box-header with-border">
      ...
      echo $Html -> addTag('h3', $tlw["wiki_box_table"]["wikitb"], 'box-title');
      ?>
    ...
    <div class="box-body">
      ...
      $lang   = $tlw["wiki_notification"]["catdel"];
      $title1 = $tl["icons"]["i5"];
      $title2 = $tl["icons"]["i6"];
      $title3 = $tl["icons"]["i21"];
      $title4 = $tl["icons"]["i2"];
      ...
      echo envo_build_menu_wiki(0, $mheader, $lang, $title1, $title2, $title3, $title4, $title5, ' class="sortable envo_cat_move"', ' id="mheader"');
