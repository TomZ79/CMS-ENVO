...
<?php } ?>
  ...
  <form method="post" action="<?= $_SERVER['REQUEST_URI'] ?>">
    ...
    <div class="savebutton hidden-xs">
      ...
      echo $Html -> addAnchor('index.php?p=wiki&sp=categories', $tl["button"]["btn19"], '', 'btn btn-info button');
      ?>
      ...
      <div class="col-sm-8">
        <div class="box box-success">
          <div class="box-header with-border">
            ...
            echo $Html -> addTag('h3', $tlw["wiki_box_title"]["wikibt5"], 'box-title');
            ?>
              ...
              <div class="block-content">
                <div class="row-form">
                  <div class="col-sm-5">
                    ...
                    <?php
                    // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
                    echo $Html -> addTag('strong', $tlw["wiki_box_content"]["wikibc14"]);
                ...
                <div class="row-form">
                  <div class="col-sm-5">
                    ...
                    // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
                    // Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
                    echo $Html -> addTag('strong', $tlw["wiki_box_content"]["wikibc15"]);
                    echo $Html -> addAnchor('javascript:void(0)', '<i class="fa fa-question-circle"></i>', '', 'cms-help', array ( 'data-content' => $tlw["wiki_help"]["wikih3"], 'data-original-title' => $tlw["wiki_help"]["wikih"] ));
                    echo $Html -> addTag('span', '*', 'star-item text-danger-800 m-l-10');
                    ?>
                ...
                <div class="row-form">
                  <div class="col-sm-5">
                    ...
                    <?php
                    // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
                    echo $Html -> addTag('strong', $tlw["wiki_box_content"]["wikibc16"]);
                    ?>
                ...
                <div class="row-form">
                  <div class="col-sm-5">
                    ...
                    <?php
                    // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
                    echo $Html -> addTag('strong', $tlw["wiki_box_content"]["wikibc17"]);
                    ?>
                ...
                <div class="row-form">
                  <div class="col-sm-5">
                    ...
                    <?php
                    // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
                    echo $Html -> addTag('strong', $tlw["wiki_box_content"]["wikibc18"]);
                    ?>
      ...
      <div class="col-sm-4">
        <div class="box box-success">
          <div class="box-header with-border">
            ...
            echo $tlw["wiki_box_title"]["wikibt8"];
            // Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
                ...
                <div class="row-form">
                  <div class="col-sm-12">
                    <select name="envo_permission[]" multiple="multiple" class="form-control">
                      ...
                      echo $Html -> addOption('0', $tlw["wiki_box_content"]["wikibc13"], $selected);
