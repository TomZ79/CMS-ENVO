...
<?php if (ENVO_ASACCESS) $apedit = BASE_URL . 'admin/index.php?p=wiki&amp;sp=edit&amp;id=' . $PAGE_ID;
      ...
      <div class="col-md-12">
        ...
        <div>
          <p style="font-size: 0.9em">
            ...
            <?php
            if ($SHOWDATE) {
              echo '<span style="margin-right: 20px;"><strong>' . $tlw["wiki_frontend"]["wiki4"] . '</strong> : ' . $PAGE_TIME . '</span>';
            }
