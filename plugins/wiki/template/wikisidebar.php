    ...
    <aside class="nav-side-menu">
      ...
      <div class="menu-list">
        <ul class="menu-content collapse" id="wikisidebar">
          <?php if (isset($ENVO_WIKI_CAT) && is_array($ENVO_WIKI_CAT)) foreach ($ENVO_WIKI_CAT as $c) { ?>
            <?php if ($c["catparent"] == 0) { ?>
              ...
              ?> >
                ...
                <ul>
                  <?php if (isset($ENVO_WIKI_CAT) && is_array($ENVO_WIKI_CAT)) foreach ($ENVO_WIKI_CAT as $c1) { ?>
