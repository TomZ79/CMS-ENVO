        ...
        <div class="row-form">
          ...
          <div class="col-md-7">
            <div class="radio radio-success">
              ...
              echo $Html->addRadio('jak_newsletter', '1', ($JAK_FORM_DATA["newsletter"] == '1') ? TRUE : FALSE, 'jak_newsletter1');
              // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
              echo $Html->addLabel('jak_newsletter1', $tl["checkbox"]["chk"]);

              // Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
              echo $Html->addRadio('jak_newsletter', '0', ($JAK_FORM_DATA["newsletter"] == '0') ? TRUE : FALSE, 'jak_newsletter2');
              // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
