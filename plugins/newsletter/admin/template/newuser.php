          ...
          <tr>
            ...
            <td>
              <div class="form-group<?php if (isset($errors["e2"])) echo " has-error"; ?>"><input type="text"
                                                                                                  name="jak_email"
                                                                                                  class="form-control"
                                                                                                  value="<?php if (isset($_REQUEST["jak_name"])) echo $_REQUEST["jak_email"]; ?>"/>
              </div>
            </td>
          </tr>
          <tr>
      ...
      <div class="box-body">
        <table class="table table-striped">
          ...
          <tr>
            ...
            <td><input type="text" class="form-control" name="jak_delimiter"
                       value="<?php if (isset($_REQUEST["jak_delimiter"])) echo $_REQUEST["jak_delimiter"]; ?>"
                       placeholder=","/></td>
          </tr>
          <tr>
            <td><?php echo $tlnl["nletter"]["d23"]; ?></td>
            <td><input type="text" class="form-control" name="jak_start"
                       value="<?php if (isset($_REQUEST["jak_start"])) echo $_REQUEST["jak_start"]; ?>"
                       placeholder="1"/></td>
          </tr>
          <tr>
            <td><?php echo $tl["menu"]["m9"]; ?></td>
