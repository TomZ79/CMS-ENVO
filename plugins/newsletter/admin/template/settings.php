      ...
      <div class="box-body">
        <table class="table table-striped">
          ...
          <tr>
            ...
            <td><textarea class="jakEditorLight" id="jakEditor" rows="4"
                          name="jak_description"><?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
          ...
          <tr>
            ...
            <td>
              <div class="form-group<?php if (isset($errors["e2"])) echo " has-error"; ?>">
                <input class="form-control" type="text" name="jak_thankyou"
                       value="<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
          ...
          <tr>
            ...
            <td>
              <div class="radio"><label><input type="radio" name="jak_smpt"
                    ...
                    if ($v["varname"] == 'nlsmtp_mail' && $v["value"] == '0') { ?> checked="checked"<?php }
                  } ?> /> <?php echo $tlnl["nletter"]["d16"]; ?></label></div>
              <div class="radio"><label><input type="radio" name="jak_smpt"
                                               value="1"<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
                    if ($v["varname"] == 'nlsmtp_mail' && $v["value"] == '1') { ?> checked="checked"<?php }
                  } ?> /> <?php echo $tlnl["nletter"]["d17"]; ?></label></div>
            </td>
          </tr>
          <tr>
            <td><?php echo $tlnl["nletter"]["d18"]; ?></td>
            <td><input type="text" class="form-control" name="jak_host"
                       value="<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
          ...
          <tr>
            ...
            <td>
              <div class="form-group<?php if (isset($errors["e3"])) echo " has-error"; ?>">
                <input type="text" class="form-control" name="jak_port"
                       value="<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
          ...
          <tr>
            ...
            <td>
              <div class="radio"><label><input type="radio" name="jak_alive"
                                               value="0"<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
                    if ($v["varname"] == 'nlsmtp_alive' && $v["value"] == '0') { ?> checked="checked"<?php }
                  } ?> /> <?php echo $tl["general"]["g19"]; ?></label></div>
              <div class="radio"><label><input type="radio" name="jak_alive"
                                               value="1"<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
                    if ($v["varname"] == 'nlsmtp_alive' && $v["value"] == '1') { ?> checked="checked"<?php }
          ...
          <tr>
            ...
            <td>
              <div class="radio"><label><input type="radio" name="jak_auth"
                                               value="0"<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
                    if ($v["varname"] == 'nlsmtp_auth' && $v["value"] == '0') { ?> checked="checked"<?php }
                  } ?> /> <?php echo $tl["general"]["g19"]; ?></label></div>
              <div class="radio"><label><input type="radio" name="jak_auth"
                                               value="1"<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
                    if ($v["varname"] == 'nlsmtp_auth' && $v["value"] == '1') { ?> checked="checked"<?php }
                  } ?> /> <?php echo $tl["general"]["g18"]; ?></label></div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="form-group<?php if (isset($errors["e3"])) echo " has-error"; ?>">
                <input type="text" class="form-control" name="jak_prefix"
                       value="<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
          ...
          <tr>
            ...
            <td><input type="text" class="form-control" name="jak_password"
                       value="<?php if (isset($JAK_SETTING) && is_array($JAK_SETTING)) foreach ($JAK_SETTING as $v) {
          ...
          <tr>
            ...
            <td><input type="submit" name="testMail" class="btn btn-success" id="sendTM"
                       value="<?php echo $tlnl["nletter"]["d42"]; ?>"/> <span id="loader" style="display: none;"><img
                  src="../../img/loader.gif" alt="loader" width="16" height="11"/></span></td>
          </tr>
        </table>
      </div>
