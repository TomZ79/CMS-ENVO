<div class="box box-primary">
  ...
  <div class="box-body">
    <table class="table table-striped">
      <tr>
        <td>
          <div class="radio"><label><input type="radio" name="jak_newsletter" value="1"<?php if (!$JAK_FORM_DATA) {
          ...
          <div class="radio"><label><input type="radio" name="jak_newsletter" value="0"<?php if (!$JAK_FORM_DATA) {
