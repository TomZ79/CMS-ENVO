  ...
  <div class="row">
    <div class="col-sm-12 m-t-20">
      ...
      <div class="m-b-30">
        ...
        <div data-pages="card" class="card card-transparent" id="card-basic">
          <div class="card-header separator">
            <div class="card-title"><?php echo $tlnl["newsletter_install"]["nlinst2"]; ?></div>
      ...
      */
      ...
      $insertphpcode = 'if (isset($defaults[\'envo_newsletter\'])) {
	$insert .= \'newsletter = \"\'.$defaults[\'envo_newsletter\'].\'\",\'; }';
