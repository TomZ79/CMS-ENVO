									...
									<div class="row-form" style="padding: 12px 5px;">
										...
										<div class="col-sm-3">
											<div class="form-group m-0">
												...
												<?php
												// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
												echo $Html -> addInput('text', 'envo_house_maingpsstreet', $ENVO_FORM_DATA["maingpsstreet"], '', 'form-control');
												?>
													...
													if (isset($ENVO_CITY) && is_array($ENVO_CITY)) {
														foreach ($ENVO_CITY as $keydistrict => $districtitem) {
															...
															foreach ($districtitem as $c) {
																...
																// Add Html Element -> addOption (Arguments: value, text, selected, id, class, optional assoc. array)
																echo $Html -> addOption($c["id"], $c["city_name"], ($c["id"] == $ENVO_FORM_DATA["maingpscity"]) ? TRUE : FALSE, '', '', array ('data-city_id' => $c["id"], 'data-city_name' => $c["city_name"], 'data-city_cuzk_code' => $c["city_cuzk_code"]));
									...
									<div class="row-form" style="padding: 12px 5px;">
										...
										<div class="col-sm-2">
											...
											<div class="form-group m-0">
												...
												<?php
												// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
												echo $Html -> addInput('text', 'envo_house_maingpslat', $ENVO_FORM_DATA["maingpslat"], '', 'form-control');
												?>
										...
										<div class="col-sm-2">
											...
											<div class="form-group m-0">
												...
												<?php
												// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
												echo $Html -> addInput('text', 'envo_house_maingpslng', $ENVO_FORM_DATA["maingpslng"], '', 'form-control');
												?>
										...
										<div class="col-sm-3 text-center mainmaps">
											...
											if (isset($ENVO_FORM_DATA["maingpslat"]) && isset($ENVO_FORM_DATA["maingpslng"])) {
												...
												// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
												echo $Html -> addAnchor('https://mapy.cz/zakladni?x=' . $ENVO_FORM_DATA["maingpslng"] . '&y=' . $ENVO_FORM_DATA["maingpslat"] . '&z=18&l=0&source=coor&id=' . $ENVO_FORM_DATA["maingpslng"] . '%2C' . $ENVO_FORM_DATA["maingpslat"], 'Mapy.cz', '', 'mapycz', array ('target' => 'MapGPS'));
												// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
												echo $Html -> addTag('span', '|', 'm-l-10 m-r-10');
												// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
												echo $Html -> addAnchor('https://www.openstreetmap.org/?mlat=' . $ENVO_FORM_DATA["maingpslat"] . '&amp;mlon=' . $ENVO_FORM_DATA["maingpslng"] . '&amp;zoom=18#map=18/' . $ENVO_FORM_DATA["maingpslat"] . '/' . $ENVO_FORM_DATA["maingpslng"], 'OpenStreetMaps', '', 'openstreet', array ('target' => 'MapGPS'));
								...
								<div class="block-content">
												...
												<select name="envo_house_cuzk_ku" class="form-control selectpicker" data-search-select2="true" data-placeholder="Výběr katastrálního území">
													...
													foreach ($ENVO_KU as $keyku => $itemku) {
														...
														foreach ($itemku as $item) {
															...
															// Add Html Element -> addOption (Arguments: value, text, selected, id, class, optional assoc. array)
															echo $Html -> addOption($item["id"], $item["ku_name"], ($item["id"] == $ENVO_FORM_DATA["cuzk_ku_id"]) ? TRUE : FALSE, '', '', array ('data-ku_name' => $item["ku_name"], 'data-ku_id' => $item["id"], 'data-ku_cuzk_code' => $item["ku_cuzk_code"]));
									...
									<div class="row-form">
										<div class="col-sm-6">
											...
											// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
											echo $Html -> addAnchor('javascript:void(0)', '<i class="fa fa-question-circle"></i>', '', 'cms-help', array ('data-content' => '<strong>Český úřad zeměměřický a katastrální</strong><br>Pokud existuje více kódů pro SVJ, oddělíme tyto kódy <code>,mezera</code>', 'data-original-title' => $tlint2["int2_help"]["int2h"]));
											?>
										...
										<div class="col-sm-6" id="cuzk_objdetail_link">
											...
											if (isset($ENVO_FORM_DATA["cuzk_objcode"])) {
												...
												foreach ($ocodearray as $oc) {
													// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
													echo $Html -> addAnchor('http://vdp.cuzk.cz/vdp/ruian/stavebniobjekty/' . $oc, 'Zobrazit detail objektu', '', '', array ('target' => 'WindowCUZK'));
													echo '<br>';
												}
											} else {
												// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
											...
											<div class="form-group m-0">
												<select name="envo_housetypeuse" class="form-control selectpicker" data-search-select2="true" data-placeholder="Výběr typu využití">
													...
													if (isset($ENVO_TYPE_USE) && is_array($ENVO_TYPE_USE)) foreach ($ENVO_TYPE_USE as $tu) {
														...
														// Add Html Element -> addOption (Arguments: value, text, selected, id, class, optional assoc. array)
														echo $Html -> addOption($tu["id"], $tu["name"], ($tu["id"] == $ENVO_STATISTICAL["p_typeuse"]) ? TRUE : FALSE, '', '');
											...
											<div class="form-group m-0">
												<select name="envo_houseperiodconstruction" class="form-control selectpicker" data-search-select2="true" data-placeholder="Výběr období">
													...
													if (isset($ENVO_PERIOD_CONSTRUCTION) && is_array($ENVO_PERIOD_CONSTRUCTION)) foreach ($ENVO_PERIOD_CONSTRUCTION as $pc) {
														...
														// Add Html Element -> addOption (Arguments: value, text, selected, id, class, optional assoc. array)
														echo $Html -> addOption($pc["id"], $pc["name"], ($pc["id"] == $ENVO_STATISTICAL["p_construction"]) ? TRUE : FALSE, '', '');
											...
											<div class="form-group m-0">
												<select name="envo_housebuildingstructure" class="form-control selectpicker" data-search-select2="true" data-placeholder="Výběr materiálu">
													...
													if (isset($ENVO_BUILDING_STRUCTURE) && is_array($ENVO_BUILDING_STRUCTURE)) foreach ($ENVO_BUILDING_STRUCTURE as $bs) {
														...
														// Add Html Element -> addOption (Arguments: value, text, selected, id, class, optional assoc. array)
														echo $Html -> addOption($bs["id"], $bs["name"], ($bs["id"] == $ENVO_STATISTICAL["b_structure"]) ? TRUE : FALSE, '', '');
											...
											<div class="form-group m-0">
												<select name="envo_housetype" class="form-control selectpicker" data-search-select2="true" data-placeholder="Výběr druhu domu">
													...
													if (isset($ENVO_TYPE_HOUSE) && is_array($ENVO_TYPE_HOUSE)) foreach ($ENVO_TYPE_HOUSE as $th) {
														...
														// Add Html Element -> addOption (Arguments: value, text, selected, id, class, optional assoc. array)
														echo $Html -> addOption($th["id"], $th["name"], ($th["id"] == $ENVO_STATISTICAL["p_typehouse"]) ? TRUE : FALSE, '', '');
								...
								<div class="block-content">
									...
									<div class="row-form">
										<div class="col-sm-12">
											...
											// Add Html Element -> addTextarea (Arguments: name, value, rows, cols, optional assoc. array)
											echo $Html -> addTextarea('envo_estatemanagementdesc', $ENVO_FORM_DATA["estatemanagementdesc"], '4', '', array ('class' => 'form-control'));
											?>
									...
									<div class="row-form">
										...
										<div class="col-sm-7">
											<div class="form-group m-0">
												...
												<?php
												// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
												echo $Html -> addInput('text', 'envo_datedministration', ($ENVO_FORM_DATA["administrationdate"] ? date("d-m-Y", strtotime( $ENVO_FORM_DATA["administrationdate"] )) : ''), 'datepickerTime', 'form-control', array ('readonly' => 'readonly'));
												?>
							...
							foreach ($ENVO_FORM_DATA_ENT as $e) { ?>
								...
								<div class="box box-success" id="ent_<?= $e["id"] ?>">
									...
									<div class="box-footer">
										...
										// EDIT
										echo $Html -> addButton('button', '', '<i class="fa fa-edit"></i> Editace vchodu', '', '', 'btn btn-default float-right m-r-20 editEnt', array ('data-toggle' => 'tooltipEnvo', 'data-placement' => 'bottom', 'title' => $tl["icons"]["i2"], 'data-dialog' => 'entDialogEdit', 'data-id' => $e["id"]));
										?>
				...
				<div class="col-sm-12 p-l-15 p-r-15 ">
					<div class="form-inline float-lg-right float-md-right float-sm-right">
						<div class="form-group">
							...
							<?php
							// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
							echo $Html -> addInput('text', 'addContact', '', '', 'form-control ml-2', array ('style' => 'height: 35px;width: 300px;', 'placeholder' => 'Jméno a příjmení'));
							?>
						...
						<div class="form-group">
							...
							<?php
							// Add Html Element -> addButton (Arguments: type, value, text, name, id, class, optional assoc. array)
							echo $Html -> addButton('button', '', 'Přidat nový kontakt', '', 'addContact', 'btn btn-info ml-2', array ('data-dialog' => 'contDialogAdd', 'style' => 'width: 100%;'));
							?>
							...
							foreach ($ENVO_FORM_DATA_CONT as $c) { ?>
								...
								<div class="box box-success" id="cont_<?= $c["id"] ?>">
									<div class="box-header with-border">
										<div class="row">
											<div class="col-12 col-sm-8">
												...
												<?php
												// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
												echo $Html -> addTag('h3', 'Jméno a příjmení: <span class="bold">' . $c["degree"] . ' ' . $c["name"] . ' ' . $c["surname"] . '</span>', 'box-title');
												?>
											...
											<div class="col-12 col-sm-4">
												...
												<?php
												// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
												echo $Html -> addTag('span', 'Cont ID ' . $c["id"], 'float-right bold', array ('style' => 'line-height: 33px;'));
												?>
									...
									<div class="box-footer">
										...
										// Add Html Element -> addButton (Arguments: type, value, text, name, id, class, optional assoc. array)
										// DELETE
										echo $Html -> addButton('button', '', '<i class="fa fa-trash-o"></i> Odstranění kontaktu', '', '', 'btn btn-danger  float-right deleteContact', array ('data-confirm-delcont' => sprintf('Jste si jistý, že chcete odstranit kontakt <strong>%s</strong>', $c["degree"] . ' ' . $c["name"] . ' ' . $c["surname"]), 'data-toggle' => 'tooltipEnvo', 'data-placement' => 'bottom', 'title' => $tl["icons"]["i1"], 'data-id' => $c["id"]));
										// EDIT
										echo $Html -> addButton('button', '', '<i class="fa fa-edit"></i> Editace kontaktu', '', '', 'btn btn-default float-right m-r-20 editContact', array ('data-toggle' => 'tooltipEnvo', 'data-placement' => 'bottom', 'title' => $tl["icons"]["i2"], 'data-dialog' => 'contDialogEdit', 'data-id' => $c["id"]));
										?>
				...
				<div class="dialog__content">
					...
					<div class="dialog__footer">
						<div class="col-sm-12 p-l-20 p-r-20">
							...
							<?php
							// Add Html Element -> addButton (Arguments: type, value, text, name, id, class, optional assoc. array)
							echo $Html -> addButton('button', '', 'Uložit', '', 'saveContact', 'btn btn-success m-t-20 m-l-20 float-right');
							echo $Html -> addButton('button', '', 'Zavřít', '', '', 'btn btn-info m-t-20 float-right action', array ('data-dialog-close' => ''));
							?>
				...
				<div class="dialog__content">
					...
					<div class="dialog__footer">
						<div class="col-sm-12 p-l-20 p-r-20">
							...
							<?php
							// Add Html Element -> addButton (Arguments: type, value, text, name, id, class, optional assoc. array)
							echo $Html -> addButton('button', '', 'Uložit', '', 'udpateContact', 'btn btn-success m-t-20 m-l-20 float-right');
							echo $Html -> addButton('button', '', 'Zavřít', '', '', 'btn btn-info m-t-20 float-right action', array ('data-dialog-close' => ''));
							?>
                            ...
                            <input type="file" name="input-file" id="fileinput_doc" accept=".doc, .docx, .docm, .xls, .xlsx, .xlsm, .pdf, .ai, jpg, jpeg, png, rar, zip"/>
								...
								<div class="col-sm-6">
									<div>
										...
										<?php
										// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
										echo $Html -> addAnchor('', 'Předdefinované texty', 'textSelect_docu', 'float-right', array ('data-toggle' => 'tooltipEnvo', 'data-placement' => 'bottom', 'title' => 'Výběr předdefinovaného textu'));
										?>
									</div>
                            ...
                            <input type="file" name="input-file" id="fileinput_img" accept="image/*"/>
								...
								<div class="col-sm-3">
									...
									<div class="form-group m-t-10">
										...
										<?php
										// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
										echo $Html -> addInput('text', 'envo_sdescimg', '', '', 'form-control', array ('placeholder' => 'Popis souboru'));
										?>
								...
								<div class="col-sm-12">
									<div id="gallery_envo_0" class="gallery_envo">
										...
										<div id="dateblock_0" class="dateblock_0 m-b-20 clearfix" style="display: none">
											<div id="dateblock_0_header" class="padding-10 m-b-20" style="background-color: #FFE858;color:#000;font-weight:700;">New Uploaded</div>
										</div>
                                    ...
                                    <div class="text">
                                      <a data-fancybox="gallery-0" href="/' . ENVO_FILES_DIRECTORY . $imgarray["mainfolder"] . $imgarray["filenamethumb"] . '" data-caption="' . ($imgarray["shortdescription"] ? $imgarray["shortdescription"] : "NO SHORT DESCRIPTION") . ($imgarray["description"] ? " - " . $imgarray["description"] : "") . '" class="btn btn-info btn-xs btn-mini fs-14" data-toggle="tooltipEnvo" data-placement="bottom" title="Zoom +">
                                         <i class="pg-image" style="position: relative;top: 2px;"></i>
													...
													echo '<p class="mb-0"><strong>Datum pořízení:</strong><span class="m-l-10">' . date($ENVO_SETTING_VAL['int2dateformat'], strtotime($imgarray["exifcreatedate"])) . '</span></p>';
													echo '<p class="mb-0"><strong>Datum uploadu:</strong><span class="m-l-10">' . date("d/m/Y", $imgarray["ftime"]) . '</span></p>';
                                    ...
                                    <div class="text">
                                      ...
                                      <button class="btn btn-info btn-xs btn-mini fs-14 delete-img" type="button" data-id="' . $img["id"] . '" data-confirm-delimg="Jste si jistý, že chcete odstranit obrázek?" data-toggle="tooltipEnvo" data-placement="bottom" title="Odstranit">
                                        <i class="fa fa-trash"></i>
												...
												echo '<p class="mb-0"><strong>Datum pořízení:</strong><span class="m-l-10">' . date($ENVO_SETTING_VAL['int2dateformat'], strtotime($img["exifcreatedate"])) . '</span></p>';
												echo '<p class="mb-0"><strong>Datum uploadu:</strong><span class="m-l-10">' . date("d/m/Y", $img["ftime"]) . '</span></p>';
									...
									<div class="row">
										...
										<div class="col-sm-2">
											...
											<div class="form-group m-t-10">
												...
												<?php
												// Add Html Element -> addInput (Arguments: type, name, value, id, class, optional assoc. array)
												echo $Html -> addInput('text', 'envo_videodate', '', '', 'form-control', array ('placeholder' => 'Datum videa'));
												?>
                                    ...
                                    <div class="text">
                                      ...
                                      <button class="btn btn-info btn-xs btn-mini fs-14 delete-video" type="button" data-id="' . $video["id"] . '" data-confirm-delvideo="Jste si jistý, že chcete odstranit video?">
                                        <i class="fa fa-trash"></i>
												...
												echo '<p class="mb-0"><strong>Datum videa:</strong><span class="videodate m-l-10">' . date($ENVO_SETTING_VAL['int2dateformat'], strtotime($video["videotime"])) . '</span></p>';
												echo '<p class="mb-0"><strong>Datum uploadu:</strong><span class="uploaddate m-l-10">' . date($ENVO_SETTING_VAL['int2dateformat'], strtotime($video["created"])) . '</span></p>';
												echo '</div>';
...
<?php
include_once APP_PATH . 'plugins/intranet2/admin/modal/int2_selecttext_modal.php';
