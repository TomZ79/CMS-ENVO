...
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . '/admin/config.php')) die('[' . __DIR__ . '/int2_table_dialog_img.php] => "config.php" not found');
					...
					<div class="row m-b-10">
						<div class="col-sm-6">
							<div class="form-group m-0">
								<select name="envo_imgcategory_dialog" class="form-control selectpicker" style="width:100%;" data-placeholder="Výběr kategorie">
									<option value=""></option>
