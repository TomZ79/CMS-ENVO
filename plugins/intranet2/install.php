...
(2, 1, 1, 'Nejdek')");
				 ...
				 */
				$envodb -> query('CREATE TABLE IF NOT EXISTS ' . DB_PREFIX . 'int2_settings_cityarea (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `region_id` INT(11) NULL DEFAULT NULL,
  `district_id` INT(11) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
				...
				$envodb -> query("INSERT INTO " . DB_PREFIX . "int2_settings_cityarea VALUES
(1, 1, 1, 1, 'Karlovy Vary'),
(2, 1, 1, 1, 'Bohatice'),
(3, 1, 1, 1, 'Cihelny'),
(4, 1, 1, 1, 'Čankov'),
(5, 1, 1, 1, 'Doubí'),
...
(10, 'Bronislava Hánělová', 'www.snkv.cz')");
  ...
  PRIMARY KEY (`id`)
				 ...
				 * CZ: Vytvoření tabulky pro pBytový dům - Foto Galerie
				 */
  ...
  `timefile` DATETIME NOT NULL DEFAULT \'0000-00-00 00:00:00\',
