            ...
            <ul>
              ...
              <li class="read-more">
                <a href="<?php echo $v["parseurl"]; ?>"
                   class="btn btn-color btn-sm"><?php echo $tl["general"]["g3"]; ?></a>
                <?php if (JAK_ASACCESS) { ?>
                  <a class="btn btn-default btn-sm jaktip"
                     href="<?php echo BASE_URL; ?>admin/index.php?p=retailer&amp;sp=edit&amp;id=<?php echo $v["id"]; ?>"
                     title="<?php echo $tl["general"]["g"]; ?>"><i class="fa fa-pencil"></i></a>
                  <a class="btn btn-default btn-sm jaktip quickedit"
                     href="<?php echo BASE_URL; ?>admin/index.php?p=retailer&amp;sp=quickedit&amp;id=<?php echo $v["id"]; ?>"
