  ...
  <?php if (isset($JAK_RETAILER) && is_array($JAK_RETAILER)) foreach ($JAK_RETAILER as $ret) { ?>
    ...
    <div class="col-md-3 col-sm-6">
      <div class="jak-post">
        ...
        <!-- End Post Info -->
        <!-- Post Image -->
        <a href="<?php echo $ret["parseurl"]; ?>"><img src="<?php echo BASE_URL . $ret["previmg"]; ?>"
                                                       alt="retailer-preview" class="post-image img-responsive"></a>
        <!-- End Post Image -->
        <!-- Post Title & Summary -->
        ...
        <div class="post-more">
          ...
          <?php if (JAK_ASACCESS) { ?>
            ...
            <a href="<?php echo BASE_URL; ?>admin/index.php?p=retailer&amp;sp=edit&amp;id=<?php echo $ret["id"]; ?>"
               title="<?php echo $tl["general"]["g"]; ?>" class="btn btn-default jaktip"><i
                class="fa fa-pencil"></i></a>

            <a class="btn btn-default jaktip quickedit"
               href="<?php echo BASE_URL; ?>admin/index.php?p=retailer&amp;sp=quickedit&amp;id=<?php echo $ret["id"]; ?>"
