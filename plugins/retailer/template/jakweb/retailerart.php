...
<?php if (JAK_ASACCESS) $apedit = BASE_URL . 'admin/index.php?p=retailer&amp;sp=edit&amp;id=' . $PAGE_ID;
$qapedit = BASE_URL . 'admin/index.php?p=retailer&amp;sp=quickedit&amp;id=' . $PAGE_ID;
  ...
  <div id="printdiv">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <?php if ($RETAILER_IMG2) { ?>
          <a href="<?php echo $RETAILER_IMG2; ?>" data-lightbox="g"><img src="<?php echo $RETAILER_IMG2; ?>" alt="img2"
                                                                         width="150"/></a>
        <?php }
        if ($RETAILER_IMG3) { ?>
          <a href="<?php echo $RETAILER_IMG3; ?>" data-lightbox="g"><img src="<?php echo $RETAILER_IMG3; ?>" alt="img3"
                                                                         width="150"/></a>
        <?php } ?>
      </div>
      <!-- End Image Column -->
      ...
      <div class="zoom-item-description col-sm-6">
        ...
        <ul class="no-list-style">
          ...
          <?php }
          if ($RETAILER_WEBURL) { ?>
            <li class="zoom-visit-btn"><a href="<?php echo $RETAILER_WEBURL; ?>"
                                          class="btn"><?php echo $tlre['retailer']['d6']; ?></a></li>
          <?php } ?>
        </ul>
      </div>
    ...
    <div class="jak-post jak-single-post">
      ...
      <div class="directions">
        <p><img src="<?php echo BASE_URL; ?>plugins/retailer/img/customer-loc.png"
                alt="your-position"/> <?php echo $tlre['retailer']['g15']; ?><br/><img
            src="<?php echo BASE_URL; ?>plugins/retailer/img/customer-ret.png"
            alt="retailer-position"/> <?php echo $RETAILER_ADDRESS_MAP; ?></p>
      ...
      <?php if (JAK_RETAILERRATE && $SHOWVOTE && $USR_CAN_RATE) {
              ...
              <li>
                <div class="comment-wrapper">
                  ...
                  <div class="comment-actions">
                    ...
                    <?php }
                    if (JAK_USERID && JAK_RETAILERPOSTDELETE && $v["userid"] == JAK_USERID || JAK_RETAILERMODERATE) { ?>
