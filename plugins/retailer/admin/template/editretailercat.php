              ...
              <tr>
                ...
                <td>
                  <div class="radio"><label><input type="radio" name="jak_active"
                                                   value="1"<?php if ($JAK_FORM_DATA["active"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_active"
                                                   value="0"<?php if ($JAK_FORM_DATA["active"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label></div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="input-group">
                    <input type="text" name="jak_img" id="jak_img" data-placement="topRight" class="form-control"
                           value="<?php echo $JAK_FORM_DATA["catimg"]; ?>">
              ...
              <tr>
                ...
                <td>
                  ...
                  <select name="jak_markerc" class="form-control">
                    ...
                    <option value="red"<?php if ($JAK_FORM_DATA["markercolor"] == 'red') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q14"]; ?></option>
                    <option value="blue"<?php if ($JAK_FORM_DATA["markercolor"] == 'blue') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q15"]; ?></option>
                    <option value="green"<?php if ($JAK_FORM_DATA["markercolor"] == 'green') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q17"]; ?></option>
                    <option value="pink"<?php if ($JAK_FORM_DATA["markercolor"] == 'pink') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q18"]; ?></option>
                    <option value="purple"<?php if ($JAK_FORM_DATA["markercolor"] == 'purple') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q19"]; ?></option>
                    <option value="magenta"<?php if ($JAK_FORM_DATA["markercolor"] == 'magenta') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q16"]; ?></option>
                    <option value="orange"<?php if ($JAK_FORM_DATA["markercolor"] == 'orange') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q22"]; ?></option>
                    <option value="turquoise"<?php if ($JAK_FORM_DATA["markercolor"] == 'turquoise') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q23"]; ?></option>
                    <option value="gold"<?php if ($JAK_FORM_DATA["markercolor"] == 'gold') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q24"]; ?></option>
                    <option value="black"<?php if ($JAK_FORM_DATA["markercolor"] == 'black') {
                      echo ' selected="selected"';
                    } ?>><?php echo $tlre["retailer"]["q20"]; ?></option>
                    <option value="white"<?php if ($JAK_FORM_DATA["markercolor"] == 'white') {
                      echo ' selected="selected"';
