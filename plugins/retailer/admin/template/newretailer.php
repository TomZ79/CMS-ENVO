              ...
              <div class="box-body">
                <table class="table table-striped">
                    ...
                    <td>
                      <div class="radio"><label>
                          <input type="radio" name="jak_showtitle"
                                 value="1"<?php if (isset($_REQUEST["jak_showtitle"]) && $_REQUEST["jak_showtitle"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label></div>
                      <div class="radio"><label>
                          <input type="radio" name="jak_showtitle"
                                 value="0"<?php if (isset($_REQUEST["jak_showtitle"]) && $_REQUEST["jak_showtitle"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label></div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="radio"><label><input type="radio" name="jak_showhits"
                                                       value="1"<?php if (isset($_REQUEST["jak_showhits"]) && $_REQUEST["jak_showhits"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label></div>
                      <div class="radio"><label><input type="radio" name="jak_showhits"
                                                       value="0"<?php if (isset($_REQUEST["jak_showhits"]) && $_REQUEST["jak_showhits"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label></div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="radio"><label><input type="radio" name="jak_comment"
                                                       value="1"<?php if (isset($_REQUEST["jak_comment"]) && $_REQUEST["jak_comment"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label></div>
                      <div class="radio"><label><input type="radio" name="jak_comment"
                                                       value="0"<?php if (isset($_REQUEST["jak_comment"]) && $_REQUEST["jak_comment"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label></div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="radio"><label><input type="radio" name="jak_vote"
                                                       value="1"<?php if (isset($_REQUEST["jak_vote"]) && $_REQUEST["jak_vote"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label></div>
                      <div class="radio"><label><input type="radio" name="jak_vote"
                                                       value="0"<?php if (isset($_REQUEST["jak_vote"]) && $_REQUEST["jak_vote"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label></div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="radio"><label><input type="radio" name="jak_social"
                                                       value="1"<?php if (isset($_REQUEST["jak_social"]) && $_REQUEST["jak_social"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label></div>
                      <div class="radio"><label><input type="radio" name="jak_social"
                                                       value="0"<?php if (isset($_REQUEST["jak_social"]) && $_REQUEST["jak_social"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label></div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="radio"><label>
                          <input type="radio" name="jak_sidebar"
                                 value="1"<?php if (isset($_REQUEST["jak_sidebar"]) && $_REQUEST["jak_sidebar"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g125"]; ?>
                        </label></div>
                      <div class="radio"><label>
                          <input type="radio" name="jak_sidebar"
                                 value="0"<?php if (isset($_REQUEST["jak_sidebar"]) && $_REQUEST["jak_sidebar"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g126"]; ?>
                        </label>
                    </td>
                  </tr>
                  <tr>
		...
		<span class="input-group-btn">
         ...
         href="../js/editor/plugins/filemanager/dialog.php?type=1&subfolder=&editor=mce_0&lang=eng&fldr=&field_id=jak_img"><?php echo $tl["general"]["g69"]; ?></a>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="input-group">
                        <input type="text" name="jak_imgs" id="jak_imgs" class="form-control"
                               value="<?php if (isset($_REQUEST["jak_imgs"])) echo $_REQUEST["jak_imgs"]; ?>"/>
		<span class="input-group-btn">
		  <a class="btn btn-info ifManager" type="button"
         href="../js/editor/plugins/filemanager/dialog.php?type=1&subfolder=&editor=mce_0&lang=eng&fldr=&field_id=jak_imgs"><?php echo $tl["general"]["g69"]; ?></a>
		</span>
                      </div><!-- /input-group -->
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="input-group">
                        <input type="text" name="jak_imgb" id="jak_imgb" class="form-control"
                               value="<?php if (isset($_REQUEST["jak_imgb"])) echo $_REQUEST["jak_imgb"]; ?>"/>
		<span class="input-group-btn">
		  <a class="btn btn-info ifManager" type="button"
         href="../js/editor/plugins/filemanager/dialog.php?type=1&subfolder=&editor=mce_0&lang=eng&fldr=&field_id=jak_imgb"><?php echo $tl["general"]["g69"]; ?></a>
		</span>
                      </div><!-- /input-group -->
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td><input class="form-control" type="text" name="jak_shortcontent"
                               value="<?php if (isset($_REQUEST["jak_shortcontent"])) echo $_REQUEST["jak_shortcontent"]; ?>"
                               maxlength="255"/></td>
                  </tr>
                  <tr>
                    <td><?php echo $tlre["retailer"]["q"]; ?></td>
                    <td><input type="text" class="form-control" name="jak_address" id="address"
                               value="<?php if (isset($_REQUEST["jak_address"])) echo $_REQUEST["jak_address"]; ?>"/>
                    </td>
                  </tr>
                  <tr>
                    <td><?php echo $tlre["retailer"]["q1"]; ?></td>
                    <td><input type="text" class="form-control" name="jak_phone"
                               value="<?php if (isset($_REQUEST["jak_phone"])) echo $_REQUEST["jak_phone"]; ?>"/></td>
                  </tr>
                  <tr>
                    <td><?php echo $tlre["retailer"]["q2"]; ?></td>
                    <td><input type="text" class="form-control" name="jak_fax"
                               value="<?php if (isset($_REQUEST["jak_fax"])) echo $_REQUEST["jak_fax"]; ?>"/></td>
                  </tr>
                  <tr>
                    <td><?php echo $tl["user"]["u1"]; ?></td>
                    <td><input type="text" class="form-control" name="jak_email"
                               value="<?php if (isset($_REQUEST["jak_email"])) echo $_REQUEST["jak_email"]; ?>"/></td>
                  </tr>
                  <tr>
                    <td><?php echo $tlre["retailer"]["q9"]; ?></td>
                    <td><input class="form-control" type="text" name="jak_weburl"
                               value="<?php if (isset($_REQUEST["jak_weburl"])) echo $_REQUEST["jak_weburl"]; ?>"/></td>
                  </tr>
                  <tr>
                    <td><?php echo $tlre["retailer"]["q3"]; ?></td>
                    <td><input type="text" class="form-control" name="jak_longitude" id="longitude"
                               value="<?php if (isset($_REQUEST["jak_longitude"])) echo $_REQUEST["jak_longitude"]; ?>"/>
                    </td>
                  </tr>
                  <tr>
                    <td><?php echo $tlre["retailer"]["q4"]; ?></td>
                    <td><input type="text" class="form-control" name="jak_latitude" id="latitude"
                               value="<?php if (isset($_REQUEST["jak_latitude"])) echo $_REQUEST["jak_latitude"]; ?>"/>
                    </td>
                  </tr>
                </table>
              </div>
          ...
          <div class="col-md-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title"><?php echo $tl["title"]["t12"]; ?> <a class="cms-help"
                  ...
                  <tr>
                    <td>
                      ...
                      <select name="jak_catid[]" multiple="multiple" class="form-control">
                        ...
                        <option
                          value="0"<?php if (isset($_REQUEST["jak_catid"]) && $_REQUEST["jak_catid"] == '0') { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g24"]; ?></option>
            ...
            <?php if (JAK_TAGS) { ?>
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <table class="table">
                    <tr>
                      <td><input type="text" name="jak_tags" id="jak_tags" class="tags"
                                 value="<?php if (isset($_REQUEST["jak_tags"])) echo $_REQUEST["jak_tags"]; ?>"/></td>
                    </tr>
                  </table>
                </div>
                <div class="box-footer">
