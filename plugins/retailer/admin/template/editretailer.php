              ...
              <div class="box-body">
                <table class="table table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="radio"><label><input type="radio" name="jak_showtitle"
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="radio"><label><input type="radio" name="jak_showhits"
                                                       value="1"<?php if ($JAK_FORM_DATA["showhits"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label></div>
                      <div class="radio"><label><input type="radio" name="jak_showhits"
                                                       value="0"<?php if ($JAK_FORM_DATA["showhits"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label></div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="input-group">
                        <input type="text" name="jak_imgs" id="jak_imgs" class="form-control"
                               value="<?php echo $JAK_FORM_DATA["previmg2"]; ?>"/>
		<span class="input-group-btn">
		  <a class="btn btn-info ifManager" type="button"
                    ...
                    <td>
                      <div class="input-group">
                        <input type="text" name="jak_imgb" id="jak_imgb" class="form-control"
                               value="<?php echo $JAK_FORM_DATA["previmg3"]; ?>"/>
		<span class="input-group-btn">
		  <a class="btn btn-info ifManager" type="button"
         href="../js/editor/plugins/filemanager/dialog.php?type=1&subfolder=&editor=mce_0&lang=eng&fldr=&field_id=jak_imgb"><?php echo $tl["general"]["g69"]; ?></a>
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="text" name="jak_shortcontent"
                               value="<?php echo $JAK_FORM_DATA["shortcontent"]; ?>" maxlength="255"/></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="jak_phone" class="form-control"
                               value="<?php echo $JAK_FORM_DATA["phone"]; ?>"/></td>
                  </tr>
                  <tr>
                    <td><?php echo $tlre["retailer"]["q2"]; ?></td>
                    <td><input type="text" name="jak_fax" class="form-control"
                               value="<?php echo $JAK_FORM_DATA["fax"]; ?>"/></td>
                  </tr>
                  <tr>
                    <td><?php echo $tl["user"]["u1"]; ?></td>
                    <td><input type="text" name="jak_email" class="form-control"
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <textarea name="jak_javascript" id="jak_javascript"
                      class="hidden"><?php echo $JAK_FORM_DATA["content_javascript"]; ?></textarea>
          </div>
          <div class="box-footer">
            <button type="submit" name="save"
                    class="btn btn-primary pull-right"><?php echo $tl["general"]["g20"]; ?></button>
