<?php if (!isset($retailer_exist)) { ?>
  ...
  <li class="jakcontent">
    <div class="form-group">
      ...
      <div class="row">
        <div class="col-md-6">
          <select name="jak_showretailerorder" class="form-control selectpicker">
        ...
        <div class="col-md-6">
          <select name="jak_showretailermany" class="form-control selectpicker" data-size="5">
            <?php for ($i = 0; $i <= 10; $i++) { ?>
    ...
    <div class="actions">
      ...
      <input type="hidden" name="real_plugin_id[]" value="<?php echo JAK_PLUGIN_RETAILER; ?>"/>
