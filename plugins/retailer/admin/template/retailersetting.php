          ...
          <div class="box-body">
            ...
            <table class="table table-striped">
                ...
                <td>
                  <div class="form-group<?php if ($errors["e2"]) echo " error"; ?>">
                    <input class="form-control" type="text" name="jak_email"
                           value="<?php echo $jkv["retaileremail"]; ?>"/>
                  </div>
                </td>
              </tr>
              <tr>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <select name="jak_showretailerordern" class="form-control">
                        <option
                          value="id"<?php if ($JAK_SETTING['showretailerwhat'] == "id") { ?> selected="selected"<?php } else { ?> selected="selected"<?php } ?>><?php echo $tlre["retailer"]["d22"]; ?></option>
                        <option
                          value="title"<?php if ($JAK_SETTING['showretailerwhat'] == "title") { ?> selected="selected"<?php } ?>><?php echo $tlre["retailer"]["d8"]; ?></option>
                        <option
                          value="time"<?php if ($JAK_SETTING['showretailerwhat'] == "time") { ?> selected="selected"<?php } ?>><?php echo $tlre["retailer"]["d24"]; ?></option>
                        <option
                          value="hits"<?php if ($JAK_SETTING['showretailerwhat'] == "hits") { ?> selected="selected"<?php } ?>><?php echo $tlre["retailer"]["d25"]; ?></option>
                      </select>
                    </div>
                    <div class="col-md-6">
                      <select name="jak_showretailerorder" class="form-control">
                        <option
                          value="ASC"<?php if ($JAK_SETTING['showretailerorder'] == "ASC") { ?> selected="selected"<?php } else { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g90"]; ?></option>
                        <option
                          value="DESC"<?php if ($JAK_SETTING['showretailerorder'] == "DESC") { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g91"]; ?></option>
                      </select>
                    </div>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td><input type="text" class="form-control" name="jak_maxpost"
                           value="<?php echo $jkv["retailermaxpost"]; ?>"/></td>
              </tr>
              <tr>
                <td><?php echo $tl["setting"]["s4"]; ?></td>
                <td>
                  <div class="form-group<?php if ($errors["e3"]) echo " error"; ?>">
                    <input type="text" class="form-control" name="jak_date"
                           value="<?php echo $jkv["retailerdateformat"]; ?>"/>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="form-group<?php if ($errors["e4"]) echo " error"; ?>">
                    <input type="text" class="form-control" name="jak_time"
                           value="<?php echo $jkv["retailertimeformat"]; ?>"/>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="radio"><label><input type="radio" name="jak_retailerurl"
                                                   value="1"<?php if ($jkv["retailerurl"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_retailerurl"
                                                   value="0"<?php if ($jkv["retailerurl"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label></div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="form-group<?php if ($errors["e7"]) echo " error"; ?>">
                    <input type="text" name="jak_rssitem" class="form-control"
                           value="<?php echo $jkv["retailerrss"]; ?>"/>
                  </div>
                </td>
              </tr>
            </table>
          ...
          <div class="box-body">
            <table class="table table-striped">
              <tr>
                ...
                <td>
                  <div class="form-group">
                    <input type="text" name="jak_apikey" class="form-control"
                           value="<?php echo $jkv["retailermapkey"]; ?>"/>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <select name="jak_maptype" class="form-control">
                    ...
                    <option value="ROADMAP"<?php if ($jkv["retailermapstyle"] == 'ROADMAP') {
                      echo ' selected="selected"';
                    } ?>>RoadMap
                    </option>

                    <option value="SATELLITE"<?php if ($jkv["retailermapstyle"] == 'SATELLITE') {
                      echo ' selected="selected"';
                    } ?>>Satellite
                    </option>

                    <option value="HYBRID"<?php if ($jkv["retailermapstyle"] == 'HYBRID') {
                      echo ' selected="selected"';
                    } ?>>Hybrid
                    </option>

                    <option value="TERRAIN"<?php if ($jkv["retailermapstyle"] == 'TERRAIN') {
                      echo ' selected="selected"';
                    } ?>>Terrain
                    </option>
                ...
                <td>
                  ...
                  <select name="jak_zoom" class="form-control">
                    ...
                    <?php for ($i = 1; $i < 22; $i++) { ?>
                      ...
                      <option
                        value="<?php echo $i; ?>"<?php if ($jkv["retailerzoom"] == $i) echo ' selected="selected"'; ?>><?php echo $i; ?></option>
              ...
              <tr>
                ...
                <td><input class="form-control" type="text" name="jak_latitude"
                           value="<?php echo $jkv["retailerlat"]; ?>"/></td>
              </tr>
              <tr>
                <td><?php echo $tlre["retailer"]["q3"]; ?></td>
                <td><input class="form-control" type="text" name="jak_longitude"
                           value="<?php echo $jkv["retailerlng"]; ?>"/></td>
              </tr>
              <tr>
                <td><?php echo $tlre["retailer"]["q11"]; ?></td>
                <td>
                  <div class="radio"><label><input type="radio" name="jak_retailershowmap"
                                                   value="1"<?php if ($jkv["retailershowmap"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_retailershowmap"
                                                   value="0"<?php if ($jkv["retailershowmap"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label></div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="radio"><label><input type="radio" name="jak_retailerloc"
                                                   value="1"<?php if ($jkv["retailerlocation"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label></div>
                  <div class="radio"><label><input type="radio" name="jak_retailerloc"
                                                   value="0"<?php if ($jkv["retailerlocation"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label></div>
                </td>
              </tr>
            </table>
          ...
          <div class="box-body">
            <table class="table table-responsive">
                ...
                <td>
                  <div class="<?php if (isset($errors["e5"])) echo " has-error"; ?>">
                    <select name="jak_mid" class="form-control selectpicker">
                      <option value="2"<?php if ($jkv["retailerpagemid"] == 2) { ?> selected="selected"<?php } ?>>
                        Range 1 page
                      </option>
                      <option value="4"<?php if ($jkv["retailerpagemid"] == 4) { ?> selected="selected"<?php } ?>>
                        Range 2 page
                      </option>
                      <option value="6"<?php if ($jkv["retailerpagemid"] == 6) { ?> selected="selected"<?php } ?>>
                        Range 3 page
                      </option>
                      <option value="8"<?php if ($jkv["retailerpagemid"] == 8) { ?> selected="selected"<?php } ?>>
                        Range 4 page
                      </option>
                      <option value="10"<?php if ($jkv["retailerpagemid"] == 10) { ?> selected="selected"<?php } ?>>
                        Range 5 page
                      </option>
                    </select>
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-group<?php if ($errors["e5"]) echo " error"; ?>"><input type="text"
                                                                                           class="form-control"
                                                                                           name="jak_item"
                                                                                           value="<?php echo $jkv["retailerpageitem"]; ?>"/>
                  </div>
                </td>
              </tr>
            </table>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <textarea name="jak_css" class="form-control hidden" id="jak_css"
                      rows="20"><?php echo $jkv["retailer_css"]; ?></textarea>
          </div>
          <div class="box-footer">
            <button type="submit" name="save"
                    class="btn btn-primary pull-right"><?php echo $tl["general"]["g20"]; ?></button>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <textarea name="jak_javascript" class="form-control hidden" id="jak_javascript"
                      rows="20"><?php echo $jkv["retailer_javascript"]; ?></textarea>
          </div>
          <div class="box-footer">
            <button type="submit" name="save"
                    class="btn btn-primary pull-right"><?php echo $tl["general"]["g20"]; ?></button>
