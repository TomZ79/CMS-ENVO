                ...
                <div class="block">
                  <div class="block-content">
                    <div class="row-form">
                      ...
                      <div class="col-md-7"><?php include_once APP_PATH . "admin/template/title_new.php"; ?></div>
                    </div>
                    <div class="row-form">
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7"><input type="text" name="jak_password" class="form-control" value="<?php if (isset($_REQUEST["jak_password"])) echo $_REQUEST["jak_password"]; ?>"/></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="box">
              ...
              <div class="box-body">
                <div class="block">
                  <div class="block-content">
                    <div class="row-form">
                      <div class="col-md-5"><strong><?php echo $tld["dload"]["d10"]; ?></strong></div>
                      <div class="col-md-7">
                    ...
                    <div class="row-form">
                      <div class="col-md-5"><strong><?php echo $tld["dload"]["d11"]; ?></strong></div>
                      <div class="col-md-7">
                        <div class="input-group">
