										...
										<div class="row-form">
											...
											<div class="col-sm-7">
												<div class="radio radio-success">
													...
													<?php
													// Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
													echo $Html -> addRadio('envo_showdl', '1', ((isset($_REQUEST["envo_showdl"]) && $_REQUEST["envo_showdl"] == '1') || !isset($_REQUEST["envo_showdl"])) ? TRUE : FALSE, 'envo_showdl1');
													// Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
													echo $Html -> addLabel('envo_showdl1', $tl["checkbox"]["chk"]);

													// Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
													echo $Html -> addRadio('envo_showdl', '0', ((isset($_REQUEST["envo_showdl"]) && $_REQUEST["envo_showdl"] == '0')) ? TRUE : FALSE, 'envo_showdl2');
													// Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
												...
												<select name="envo_catid[]" multiple="multiple" class="form-control" size="10">
													...
													if (isset($ENVO_CAT) && is_array($ENVO_CAT)) foreach ($ENVO_CAT as $v) {
														...
														if ($v["catparent"] > 0) {
															...
															echo $Html -> addOption($v["id"], $v["name"], $selected, '', '', array ('style' => 'font-weight: bold;padding: 5px 0;'));
														}
													}
													?>
