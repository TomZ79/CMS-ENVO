                ...
                <table class="table table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="radio"><label>
                          <input type="radio" name="jak_showtitle"
                                 value="0"<?php if (isset($_REQUEST["showtitle"]) && $_REQUEST["showtitle"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label></div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="radio"><label>
                          <input type="radio" name="jak_comment"
                  ...
                  <tr>
                    <td><?php echo $tld["dload"]["d17"]; ?> <a class="cms-help"
                                                               data-content="<?php echo $tld["dload"]["h1"]; ?>"
                                                               href="javascript:void(0)"
                                                               data-original-title="<?php echo $tl["title"]["t21"]; ?>"><i
                          class="fa fa-question-circle"></i></a></td>
                    <td>
                      <div class="radio"><label>
                          <input type="radio" name="jak_ftshare"
                                 value="1"<?php if (isset($_REQUEST["jak_ftshare"]) && $_REQUEST["jak_ftshare"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label></div>
                      <div class="radio"><label>
                          <input type="radio" name="jak_ftshare"
                                 value="0"<?php if (isset($_REQUEST["jak_ftshare"]) && $_REQUEST["jak_ftshare"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label></div>
                    </td>
                  </tr>
                  <tr>
		...
		<span class="input-group-btn">
         ...
         href="../js/editor/plugins/filemanager/dialog.php?type=1&subfolder=&editor=mce_0&lang=eng&fldr=&field_id=jak_img"><?php echo $tl["general"]["g69"]; ?></a>
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="jak_password" class="form-control"
          ...
          <div class="col-md-4">
                ...
                <table class="table table-striped">
                  <tr>
                    <td><select name="jak_permission[]" multiple="multiple" class="form-control">
                        <option
                          value="0"<?php if (isset($_REQUEST["jak_permission"]) && $_REQUEST["jak_permission"] == '0') { ?> selected="selected"<?php } ?>><?php echo $tld["dload"]["d31"]; ?></option>
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title"><?php echo $tld["dload"]["d13"]; ?> <a class="cms-help"
                                                                             data-content="<?php echo $tld["dload"]["h"]; ?>"
                                                                             href="javascript:void(0)"
                                                                             data-original-title="<?php echo $tl["title"]["t21"]; ?>"><i
                      class="fa fa-question-circle"></i></a></h3>
              </div><!-- /.box-header -->
              <div class="box-body">
                <table class="table table-striped">
                  <tr>
                    ...
                    <td><select name="jak_file" class="form-control">
                        <option
                          value="0"><?php echo $tld["dload"]["d12"]; ?></option><?php if (isset($site_dload_files) && is_array($site_dload_files)) foreach ($site_dload_files as $l) { ?>
                    ...
                    <td>
                      <div class="input-group">
                        <input type="text" name="jak_extfile" id="ext_file" class="form-control"
                               value="<?php if (isset($_REQUEST["jak_extfile"])) echo $_REQUEST["jak_extfile"]; ?>"/>
		<span class="input-group-btn">
		  <a class="btn btn-info ifManager" type="button"
