					...
					<table class="table table-striped table-hover">
						...
						<?php if (isset($JAK_DOWNLOAD_SORT) && is_array ($JAK_DOWNLOAD_SORT)) foreach ($JAK_DOWNLOAD_SORT as $v) { ?>
							<tr>
								...
								<td>
									<a href="index.php?p=download&amp;sp=lock&amp;ssp=<?php echo $v["id"]; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?php if ($v["active"] == '0') {
										echo $tl["icons"]["i5"];
									} else {
										echo $tl["icons"]["i6"];
									} ?>">
								...
								<td>
									<a href="index.php?p=download&amp;sp=delete&amp;ssp=<?php echo $v["id"]; ?>" class="btn btn-default btn-xs" data-confirm="<?php echo $tld["dload"]["al"]; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $tl["icons"]["i1"]; ?>">
