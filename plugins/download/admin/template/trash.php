        ...
        <table class="table table-striped">
          ...
          <tr>
            ...
            <th>
              ...
              echo $Html->addButtonSubmit('untrash', '<i class="fa fa-thumbs-up"></i>', 'button_lock', 'btn btn-default btn-xs', array('onclick' => 'if(!confirm(\'' . $tld["downl_notification"]["untrash"] . '\'))return false;'));
              ?>
