...
<?php if (isset($JAK_DL_CAT_EXIST)) { ?>
  ...
  <div class="box box-success">
    ...
    <div class="box-body">
      ...
      $lang   = $tl["downl_notification"]["catdel"];
      $title1 = $tl["icons"]["i5"];
      $title2 = $tl["icons"]["i6"];
      $title3 = $tl["icons"]["i24"];
      $title4 = $tl["icons"]["i2"];
      ...
      echo envo_build_menu_download(0, $mheader, $lang, $title1, $title2, $title3, $title4, $title5, ' class="sortable jak_cat_move"', ' id="mheader"');
  ...
  <div class="col-md-12">
    <div class="icon_legend">
      ...
      echo $Html->addTag('i', '', 'fa fa-sticky-note-o', array('data-toggle' => 'tooltipEnvo', 'title' => $tl["icons"]["i24"]));
