		...
		<div class="col-md-4 col-sm-6">
			<div class="jak-post">
				...
				<div class="jak-post-mask">
					<a href="<?php echo $d["parseurl"]; ?>"><img src="<?php echo BASE_URL . $d["previmg"]; ?>" alt="blog-preview"
							class="post-image img-responsive">
						<div class="mask">
							<?php if ($d["showdate"]) { ?><i class="fa fa-clock-o"></i> <?php echo $d["created"]; ?><?php } ?><span
								class="pull-right"><i class="fa fa-eye"></i> <?php echo $tl["global_text"]["gtxt"] . $d["hits"]; ?></span>
						</div>
					</a>
				</div>
				<!-- End Post Image -->
				...
				<div class="post-title">
					<h3 class="text-color"><span><a
								href="<?php echo $d["parseurl"]; ?>"><?php echo jak_cut_text ($d["title"], 30, ""); ?></a></span></h3>
				</div>
				...
				<div class="post-more">
					<a href="<?php echo $d["parseurl"]; ?>" class="btn btn-color btn-sm"><i
							class="fa fa-download"></i> <?php echo $tld["dload"]["d2"]; ?></a>
					<?php if (JAK_ASACCESS) { ?>

						<a href="<?php echo BASE_URL; ?>admin/index.php?p=download&amp;sp=edit&amp;id=<?php echo $d["id"]; ?>"
							title="<?php echo $tl["general"]["g"]; ?>" class="btn btn-default btn-sm jaktip"><i
								class="fa fa-pencil"></i></a>

						<a class="btn btn-default btn-sm jaktip quickedit"
							href="<?php echo BASE_URL; ?>admin/index.php?p=download&amp;sp=quickedit&amp;id=<?php echo $d["id"]; ?>"
