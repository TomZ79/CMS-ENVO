      ...
      <div class="col-sm-6">
        <div class="jak-post">
          ...
          <div class="jak-post-mask">
            <a href="<?php echo $v["parseurl"]; ?>"><img src="<?php echo BASE_URL . $v["previmg"]; ?>"
                                                         alt="blog-preview" class="post-image img-responsive">
              <div class="mask">
                <?php if ($v["showdate"]) { ?><i class="fa fa-clock-o"></i> <?php echo $v["created"]; ?><?php } ?><span
                  class="pull-right"><i class="fa fa-eye"></i> <?php echo $tl["general"]["g13"] . $v["hits"]; ?></span>
              </div>
            </a>
          </div>
          <!-- End Post Image -->
          ...
          <div class="post-more">
            ...
            <?php if (JAK_ASACCESS) { ?>
              ...
              <a href="<?php echo BASE_URL; ?>admin/index.php?p=download&amp;sp=edit&amp;id=<?php echo $v["id"]; ?>"
                 title="<?php echo $tl["general"]["g"]; ?>" class="btn btn-default btn-sm jaktip"><i
                  class="fa fa-pencil"></i></a>

              <a class="btn btn-default btn-sm jaktip quickedit"
                 href="<?php echo BASE_URL; ?>admin/index.php?p=download&amp;sp=quickedit&amp;id=<?php echo $v["id"]; ?>"
