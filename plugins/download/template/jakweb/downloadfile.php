      ...
      <div class="row">
        <?php if ($FT_SHARE) { ?>
          <div class="col-sm-8">
            ...
            <p><a href="javascript:void(0)" id="tweetLink" class="btn btn-info"><i class="fa fa-twitter fa-2x"></i></a>
              <a href="javascript:void(0)" id="faceLink" class="btn btn-primary"><i
