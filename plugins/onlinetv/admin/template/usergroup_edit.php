				...
				<div class="row-form">
					...
					<div class="col-sm-7">
						<div class="radio radio-success">
							...
							echo $Html -> addRadio('envo_onlinetvplugin', '1', ($ENVO_FORM_DATA["onlinetv"] == '1') ? TRUE : FALSE, 'envo_onlinetvplugin1');
							// Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
							echo $Html -> addLabel('envo_onlinetvplugin1', $tl["checkbox"]["chk"]);

							// Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
							echo $Html -> addRadio('envo_onlinetvplugin', '0', ($ENVO_FORM_DATA["onlinetv"] == '0') ? TRUE : FALSE, 'envo_onlinetvplugin2');
							// Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
