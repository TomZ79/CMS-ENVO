          ...
          <table class="table table-striped table-hover">
            ...
            <?php if (isset($JAK_SLIDER_ALL) && is_array($JAK_SLIDER_ALL)) foreach ($JAK_SLIDER_ALL as $v) { ?>
              <tr>
                ...
                <td>
                  <a href="index.php?p=slider&amp;sp=delete&amp;ssp=<?php echo $v["id"]; ?>" class="btn btn-default btn-xs" data-confirm="<?php echo $tlls["ls"]["al"]; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $tl["icons"]["i1"]; ?>">
                    <i class="fa fa-trash-o"></i>
                  </a>
                </td>
              </tr>
