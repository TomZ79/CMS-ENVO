<select name="whatid_<?php echo $v["pluginid"]; ?>" class="form-control selectpicker">
  <option value="0"<?php if (isset($pgh["whatid"]) && $pgh["whatid"] == 0 || isset($_REQUEST["whatid_" . $v["pluginid"]]) && $_REQUEST["whatid_" . $v["pluginid"]] == 0) { ?> selected="selected"<?php } ?>><?php echo $tl["cform"]["c18"]; ?></option>
