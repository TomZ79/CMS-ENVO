<div class="box box-primary">
  ...
  <div class="box-body">
    <table class="table table-striped">
      ...
      <tr>
        <td>Delicious</td>
        <td><input type="text" name="sb_delicious" class="form-control" value="<?php echo $jkv["sb_delicious"]; ?>"/>
        </td>
      </tr>
      <tr>
        <td>Tumbler</td>
      ...
      <tr>
        ...
        <td>
          ...
          <select name="sb_show" class="form-control">
            <?php for ($i = 0; $i <= 10; $i++) { ?>
              <option
                value="<?php echo $i ?>"<?php if ($jkv["sb_show"] == $i) { ?> selected="selected"<?php } ?>><?php echo $i; ?></option>
            <?php } ?>
          </select>
      ...
      <tr>
        ...
        <td>
          ...
          <select name="sb_move" class="form-control">
            <?php for ($i = 0; $i <= 10; $i++) { ?>
              <option
                value="<?php echo $i ?>"<?php if ($jkv["sb_move"] == $i) { ?> selected="selected"<?php } ?>><?php echo $i; ?></option>
            <?php } ?>
          </select>
      ...
      <tr>
        ...
        <td>
          ...
          <select name="sb_skin" class="form-control">
            <option
              value="clear"<?php if ($jkv["sb_skin"] == 'clear') { ?> selected="selected"<?php } ?>><?php echo $tlsb["sb43"]["b8"]; ?></option>
            <option
              value="dark"<?php if ($jkv["sb_skin"] == 'dark') { ?> selected="selected"<?php } ?>><?php echo $tlsb["sb43"]["b9"]; ?></option>
          </select>
      ...
      <tr>
        ...
        <td>
          ...
          <select name="sb_position" class="form-control">
            <option
              value="left"<?php if ($jkv["sb_position"] == 'left') { ?> selected="selected"<?php } ?>><?php echo $tlsb["sb43"]["b4"]; ?></option>
            <option
              value="top"<?php if ($jkv["sb_position"] == 'top') { ?> selected="selected"<?php } ?>><?php echo $tlsb["sb43"]["b5"]; ?></option>
            <option
              value="right"<?php if ($jkv["sb_position"] == 'right') { ?> selected="selected"<?php } ?>><?php echo $tlsb["sb43"]["b6"]; ?></option>
            <option
              value="bottom"<?php if ($jkv["sb_position"] == 'bottom') { ?> selected="selected"<?php } ?>><?php echo $tlsb["sb43"]["b7"]; ?></option>
          </select>
