...
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . '/admin/config.php')) die('[' . __DIR__ . '/int_list_table_upload_img.php] => "config.php" not found');
  ...
  if ($width_o > $minDimens || $height_o > $minDimens) {
    ...
    if (in_array($ext, $valid_extensions)) {
      ...
      if (move_uploaded_file($tmp_name, $pathimgfull_original)) {
        ...
        $imgoriginalsize = filesize( $original_file );
        $imgthumbsize = filesize( $thumbs_file );
