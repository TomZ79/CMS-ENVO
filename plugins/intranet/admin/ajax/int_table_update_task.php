...
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . '/admin/config.php')) die('[' . __DIR__ . '/int_table_update_task.php] => "config.php" not found');
...
// Update row in DB
$result = $envodb->query('UPDATE ' . DB_PREFIX . 'intranethousetasks SET 
                          houseid = "' . $houseID . '",  
                          priority = "' . $priority . '", 
