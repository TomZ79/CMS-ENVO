...
<?php } ?>
  ...
  <div class="savebutton-medium hidden-xs">
    ...
    echo $Html->addAnchor('index.php?p=intranet&amp;sp=houselist&amp;ssp=newhouse', 'Nový Dům', '', 'btn btn-info button');
    ?>
          ...
          <?php foreach ($ENVO_HOUSE_ALL as $h) { ?>
            <tr>
              ...
              <td>
                ...
                <?php
                // Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
                echo $Html->addAnchor('index.php?p=intranet&amp;sp=houselist&amp;ssp=edithouse&amp;id=' . $h["id"], $h["name"]);
                ?>
