	...
	<div class="box-body no-padding">
		...
		<div class="table-responsive">
			<table class="table table-striped table-hover table-statis-200">
				<thead>
				<tr class="d-flex">
					<th class="col">Uživatel</th>
					<th class="col">Název Exportovaného Souboru</th>
					<th class="col">Datum stažení</th>
				</tr>
				</thead>
				<tbody>
				...
				<?php if (isset($tt_envodata)) foreach ($tt_envodata as $tte) { ?>
					...
					<tr class="d-flex">
						<td class="col"><?= $tte["email"] ?></td>
						<td class="col"><?= $tte["exportname"] ?></td>
						<td class="col"><?= $tte["time"] ?></td>
					</tr>
				<?php } ?>
