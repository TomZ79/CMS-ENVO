				...
				<div class="row-form">
					...
					<div class="col-sm-7">
						<div class="radio radio-success">
							...
							echo $Html -> addRadio('envo_int2', '1', ((isset($_REQUEST["envo_int2"]) && $_REQUEST["envo_int2"] == '1')) ? TRUE : FALSE, 'envo_int21');
							// Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
							echo $Html -> addLabel('envo_int21', $tl["checkbox"]["chk"]);

							// Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
							echo $Html -> addRadio('envo_int2', '0', ((isset($_REQUEST["envo_int2"]) && $_REQUEST["envo_int2"] == '0') || !isset($_REQUEST["envo_int2"])) ? TRUE : FALSE, 'envo_int22');
							// Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
