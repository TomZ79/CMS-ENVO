		...
		<ul class="nav nav-tabs nav-tabs-responsive" role="tablist">
			<li class="nav-item">
				<a href="#cmsPage1" class="active" data-toggle="tab">
					...
					echo $Html -> addTag('span', $tlotv["otv_section_tab"]["otvtab"], 'text');
					?>
			...
			<li class="nav-item next">
				<a href="#cmsPage2" class="" data-toggle="tab">
					...
					<?php
					// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
					echo $Html -> addTag('span', $tlotv["otv_section_tab"]["otvtab1"], 'text');
					?>
			...
			<li class="nav-item">
				<a href="#cmsPage3" class="" data-toggle="tab">
					...
					<?php
					// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
					echo $Html -> addTag('span', $tlotv["otv_section_tab"]["otvtab2"], 'text');
					?>
			...
			<li class="nav-item">
				<a href="#cmsPage4" class="" data-toggle="tab">
					...
					<?php
					// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
					echo $Html -> addTag('span', $tlotv["otv_section_tab"]["otvtab3"], 'text');
					?>
					...
					<div class="col-sm-6">
						<div class="box box-success">
							<div class="box-header with-border">
								...
								<?php
								// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
								echo $Html -> addTag('h3', $tlotv["otv_box_title"]["otvbt"], 'box-title');
								?>
									...
									<div class="block-content">
										<div class="row-form">
											<div class="col-sm-5">
												...
												<?php
												// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
												echo $Html -> addTag('strong', $tlotv["otv_box_content"]["otvbc"]);
												?>
											...
											<div class="col-sm-7">
												<div class="form-group m-0">
													...
													echo $Html -> addInput('text', 'envo_title', $ENVO_SETTING_VAL["onlinetvplugintitle"], '', 'form-control');
													?>
