...
(NULL, "tpl_between_head", "Wiki CSS", "plugins/wiki/tpl_between_head.php", "wiki", 1, 4, "' . $rows['id'] . '", NOW()),
(NULL, "tpl_footer_end", "Wiki Script", "plugins/wiki/tpl_footer_end.php", "wiki", 1, 4, "' . $rows['id'] . '", NOW()),
