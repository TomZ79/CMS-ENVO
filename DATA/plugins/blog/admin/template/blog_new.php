		...
		<ul class="nav nav-tabs nav-tabs-responsive" role="tablist">
			...
			<li class="nav-item next">
				<a href="#cmsPage2" class="" data-toggle="tab">
					...
					<?php
					// Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
					echo $Html -> addTag('span', $tlblog["blog_section_tab"]["blogtab4"], 'text');
					?>
								...
								<div class="block">
									<div class="block-content">
										...
										<div class="row-form">
											...
											<div class="col-sm-7">
												<div
														class="form-group m-0<?php if (isset($errors["e2"])) echo " has-error"; ?>">
					...
					<div class="col-sm-12">
						<div class="box box-success">
							...
							<div class="box-body">
								...
								<?php
								// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
								echo $Html -> addAnchor('../assets/plugins/tinymce/5.3.1/plugins/filemanager/dialog.php?type=2&lang=' . $managerlangTiny . '&fldr=&field_id=csseditor', $tl["global_text"]["globaltxt8"], '', 'ifManager');
					...
					<div class="col-sm-12">
						<div class="box box-success">
							...
							<div class="box-body">
								...
								<?php
								// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
								echo $Html -> addAnchor('../assets/plugins/tinymce/5.3.1/plugins/filemanager/dialog.php?type=2&lang=' . $managerlangTiny . '&fldr=&field_id=javaeditor', $tl["global_text"]["globaltxt8"], '', 'ifManager');
