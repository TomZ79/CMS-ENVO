...
if (ENVO_ACCESS) $apedit = BASE_URL . 'admin/index.php?p=wiki&amp;sp=edit&amp;id=' . $PAGE_ID;
				...
				<a href="<?= $ENVO_NAV_PREV ?>" class="portfolio-prev text-decoration-none d-block">
					<div class="d-flex align-items-center line-height-1">
						...
						<div class="d-none d-sm-block line-height-1">
							<span class="text-dark opacity-4 text-1"><?= mb_strtoupper($tlw["wiki_frontend"]["wiki8"], 'UTF-8') ?></span>
			...
			<div class="col">
				<a href="<?= $ENVO_NAV_NEXT ?>" class="portfolio-next text-decoration-none d-block float-right ">
					<div class="d-flex align-items-center text-right line-height-1">
						<div class="d-none d-sm-block line-height-1">
							<span class="text-dark opacity-4 text-1"><?= mb_strtoupper($tlw["wiki_frontend"]["wiki9"], 'UTF-8') ?></span>
