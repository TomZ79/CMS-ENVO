...
// HEADER STYLE
// Get header style for each elements
$skincarzone = explode(",", $setting["skin_Carzone_tpl"]);
$skincarzone_header = $skincarzone[0];
$skincarzone_mainheader = $skincarzone[1];
 ...
 *
 */
function build_menu_carzone($parent, $menu, $maincategory, $active, $mainclass, $dropdown, $dropdownclass, $dropclass, $subclass, $admin)
{
  // Set global variable
  global $arr1;
    ...
    foreach ($menu['parents'][$parent] as $itemId) {
      ...
      if ($maincategory) {
        if (isset($menu['parents'][$itemId])) {
          ...
          $html .= build_menu_carzone($itemId, $menu, $maincategory, $active, $dropclass, $subclass, $dropdownclass, $dropclass, $subclass, $admin);
 ...
 * @return string
 */
function build_fmenu_carzone($parent, $menu, $active)
{
  // Set global variable
  global $arr1;
  // Search 'catparent' in array by active page name
