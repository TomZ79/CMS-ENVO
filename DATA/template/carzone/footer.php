      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 text-right ">
            ...
            <?= build_fmenu_carzone(0, $mfooter, $page) ?>
...
<script src="/assets/plugins/jquery/jquery-1.12.4.min.js?=v1.12.4"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/wow.min.js"></script>
...
<script src="/template/<?= ENVO_TEMPLATE ?>/js/imagesloaded.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/masonry-3.1.4.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/masonry.filter.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/owl.carousel.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/dz.carousel.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/dz.ajax.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/jquery.themepunch.tools.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/jquery.themepunch.revolution.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/extensions/revolution.extension.actions.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/extensions/revolution.extension.migration.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/extensions/revolution.extension.video.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/plugins/revolution/v5.4.3/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/rev.slider.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/modernizr.custom.min.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/jquery.hoverdir.js"></script>

<!-- Theme Function -->
<script src="/template/<?= ENVO_TEMPLATE ?>/js/carzone.custom.js"></script>
<script src="/template/<?= ENVO_TEMPLATE ?>/js/generatedCarzone_js.php"></script>
