...
<head>
  <meta charset="utf-8">
  <title>AUTOREX Template Documentation</title>
...
<header>
  <h1>Nápověda - AUTOREX Template</h1>
  <div class="clear"></div>
</header>

<nav id="subnav">
  <h3>Obsah</h3>
  <h3>Aktuální kapitola: <span id="curnav" class="light"> O šabloně </span></h3>
</nav>
