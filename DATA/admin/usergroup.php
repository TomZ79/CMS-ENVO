        ...
        if (count($errors) == 0) {
          ...
          */
          ...
          if (!$result) {
            ...
            // EN: Redirect page
            // CZ: Přesměrování stránky
            envo_redirect(BASE_URL . 'index.php?p=usergroup&sp=edit&id=' . $rowid . '&status=s');
          }
        } else {
        ...
        if (count($errors) == 0) {
          ...
          */
          ...
          if (!$result) {
            // EN: Redirect page
            // CZ: Přesměrování stránky
            envo_redirect(BASE_URL . 'index.php?p=usergroup&sp=edit&id=' . $page2 . '&status=e');
          } else {
            // EN: Redirect page
            // CZ: Přesměrování stránky
            envo_redirect(BASE_URL . 'index.php?p=usergroup&sp=edit&id=' . $page2 . '&status=s');
          }
        } else {
