...
<div class="row">
  <div class="col-sm-9">
    <!-- Version Unreleased -->
    <div id="v_2_3_0" class="scrollspyoffset m-b-20">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h5 class="panel-title">Version Unreleased</h5>
          <div class="heading-elements">
            <span class="text-muted heading-text">2022</span>
...
[fixed] Fix php variable for admin / navbar.php, newsnav.php, tagnav.php. The new definition of variables is in admin / config.php.
[fixed] Fix typo
[fixed] ... and other more ...
...
[updated] Update RESPONSIVE filemanager (9.11.3)
  ...
  <div class="col-sm-3">
    ...
    <div class="sidebar-scroll">
      <div class="sidebar-default">
        <!-- Navigation -->
        <div id="navigation" class="no-padding">
          <ul class="nav navigation">
            <li class="navigation-header bold">
              Version history
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#v_2_3_0">Unreleased
                <span class="float-right">2022</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#v_1_2">Version 1.2
                <span class="float-right">09.27.2016</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#v_1_1">Version 1.1
                <span class="float-right">06.8.2015</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#release">Initial release
                <span class="float-right">05.8.2015</span></a>
            </li>
