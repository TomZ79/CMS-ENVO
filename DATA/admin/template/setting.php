    ...
    <ul class="nav nav-tabs nav-tabs-responsive" role="tablist">
      <li class="nav-item">
        <a href="#cmsPage1" class="active" data-toggle="tab">
          ...
          echo $Html->addTag('span', $tl["gs_section_tab"]["gstab"], 'text');
          ?>
      ...
      <li class="nav-item next">
        <a href="#cmsPage2" class="" data-toggle="tab">
          ...
          <?php
          // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
          echo $Html->addTag('span', $tl["gs_section_tab"]["gstab1"], 'text');
          ?>
      ...
      <li class="nav-item">
        <a href="#cmsPage3" class="" data-toggle="tab">
          ...
          <?php
          // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
          echo $Html->addTag('span', $tl["gs_section_tab"]["gstab2"], 'text');
          ?>
      ...
      <li class="nav-item">
        <a href="#cmsPage4" class="" data-toggle="tab">
          ...
          <?php
          // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
          echo $Html->addTag('span', $tl["gs_section_tab"]["gstab3"], 'text');
          ?>
      ...
      <li class="nav-item">
        <a href="#cmsPage5" class="" data-toggle="tab">
          ...
          <?php
          // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
          echo $Html->addTag('span', $tl["gs_section_tab"]["gstab4"], 'text');
          ?>
      ...
      <li class="nav-item">
        <a href="#cmsPage6" class="" data-toggle="tab">
          ...
          <?php
          // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
          echo $Html->addTag('span', $tl["gs_section_tab"]["gstab6"], 'text');
          ?>
      ...
      <?php if (isset($ENVO_HOOK_ADMIN_SETTING_EDIT)) { ?>
        <li class="nav-item">
          <a href="#cmsPage7" class="" data-toggle="tab">
            ...
            <?php
            // Add Html Element -> addTag (Arguments: tag, text, class, optional assoc. array)
            echo $Html->addTag('span', $tl["gs_section_tab"]["gstab5"], 'text');
            ?>
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group m-0<?php if (isset($errors["e1"])) echo " has-error"; ?>">
                          ...
                          echo $Html->addInput('text', 'envo_email', $ENVO_SETTING_VAL["email"], '', 'form-control', array('placeholder' => $tl["placeholder"]["p13"]));
                          ?>
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-sm-7">
                        <div class="radio radio-success">
                          ...
                          echo $Html->addRadio('envo_shttp', '0', ($ENVO_SETTING_VAL["sitehttps"] == '0') ? TRUE : FALSE, 'envo_shttp1');
                          // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
                          echo $Html->addLabel('envo_shttp1', $tl["gs_box_content"]["gsbc3"]);

                          // Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
                          echo $Html->addRadio('envo_shttp', '1', ($ENVO_SETTING_VAL["sitehttps"] == '1') ? TRUE : FALSE, 'envo_shttp2');
                          // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
                          echo $Html->addLabel('envo_shttp2', $tl["gs_box_content"]["gsbc4"]);
                          ?>
                      ...
                      <div class="col-sm-7">
                        <select name="envo_acetheme" class="form-control selectpicker">
                          <optgroup label="<?= $tl["gs_box_content"]["gsbc22"] ?>">
                            ...
                            echo $Html->addOption('github', 'Github', ($ENVO_SETTING_VAL["acetheme"] == 'github') ? TRUE : FALSE);
                            echo $Html->addOption('textmate', 'Textmate', ($ENVO_SETTING_VAL["acetheme"] == 'textmate') ? TRUE : FALSE);
                            ?>
                    ...
                    <div class="row-form">
                      <div class="col-sm-12">
                        ...
                        <div class="cookie-consent-configurator">
                          ...
                          <input name="envo_eucookie_theme" id="theme11-colour" class="input-hidden" value="eucookie_theme11" <?= ($ENVO_SETTING_VAL["eucookie_theme"] == 'eucookie_theme11') ? 'checked="checked"' : '' ?> type="radio">
                          <label for="theme11-colour">
                            <div class="theme-preview-container" style="background:#000;">
                              <div class="theme-preview-button" style="background:#EE0D09;"></div>
                            </div>
                          </label>
