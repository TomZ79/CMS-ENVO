		...
		<div id="expenses_total" class="tile_count">
			<div class="row">
				<div class="col-md-2 col-sm-3 col-xs-12 tile_stats_count">
					<span class="count_top">Počet uživatelů</span>
				...
				<table class="table table-striped table-hover">
					...
					<tr>
						...
						<th>
							...
							<?php
							echo $tl["user_box_table"]["usertb"];
							// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
							echo $Html -> addAnchor('index.php?p=users&amp;sp=sort&amp;ssp=username&amp;sssp=DESC', '<i class="fa fa-arrow-up"></i>', '', 'btn btn-warning btn-xs');
							echo $Html -> addAnchor('index.php?p=users&amp;sp=sort&amp;ssp=username&amp;sssp=ASC', '<i class="fa fa-arrow-down"></i>', '', 'btn btn-success btn-xs');
							?>
						...
						<th>
							...
							<?php
							echo $tl["user_box_table"]["usertb1"];
							// Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
							echo $Html -> addAnchor('index.php?p=users&amp;sp=sort&amp;ssp=email&amp;sssp=DESC', '<i class="fa fa-arrow-up"></i>', '', 'btn btn-warning btn-xs');
							echo $Html -> addAnchor('index.php?p=users&amp;sp=sort&amp;ssp=email&amp;sssp=ASC', '<i class="fa fa-arrow-down"></i>', '', 'btn btn-success btn-xs');
							?>
