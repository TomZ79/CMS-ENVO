...
if ($setting["adv_editor"]) {
  ...
  echo $Html->addTextarea('envo_lcontent', (isset($ENVO_FORM_DATA["content"])) ? envo_edit_safe_userpost(htmlspecialchars($ENVO_FORM_DATA["content"])) : '', '', '', array('id' => 'envo_editor_light', 'class' => 'form-control d-none'));
