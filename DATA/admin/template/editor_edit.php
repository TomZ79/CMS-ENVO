  ...
  <div class="box-body">
    <table class="table">
      ...
      <?php if (isset($ENVO_PAGE_BACKUP) && is_array($ENVO_PAGE_BACKUP)) { ?>
        <tr>
          <th style="padding: 8px 20px !important;">
          ...
          <?php if ($setting["adv_editor"]) { ?>
            <div id="cover">
              <div class="cover-header">
                ...
                echo $Html->addAnchor('../assets/plugins/tinymce/5.3.1/plugins/filemanager/dialog.php?type=0&lang=' . $managerlangTiny . '&fldr=&field_id=htmleditor', '<i class="fa fa-files-o"></i>', '', 'btn btn-primary btn-xs m-r-10 ifManager', array('title' => 'Show Filemanager'));
              ...
              <div id="editorContainer">
                ...
                <div id="restorediv" style="visibility: hidden;min-height: 100%;position: absolute;z-index: 10;top: 0;left: 0;min-width: 100%;background-color: rgba(255,255,255,0.9);">
                  <div id="spinner">
                    <div class="rect1"></div>
                    <div class="rect2"></div>
                    <div class="rect3"></div>
