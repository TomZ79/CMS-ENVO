                  ...
                  <div class="block-content">
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-sm-7">
                        <div class="radio radio-success">
                          ...
                          <?php
                          // Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
                          echo $Html->addRadio('envo_showhits', '1', ((isset($_REQUEST["envo_showhits"]) && $_REQUEST["envo_showhits"] == '1')) ? TRUE : FALSE, 'envo_showhits1');
                          // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
                          echo $Html->addLabel('envo_showhits1', $tl["checkbox"]["chk"]);

                          // Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
                          echo $Html->addRadio('envo_showhits', '0', ((isset($_REQUEST["envo_showhits"]) && $_REQUEST["envo_showhits"] == '0') || !isset($_REQUEST["envo_showhits"])) ? TRUE : FALSE, 'envo_showhits2');
                          // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
                    ...
                    <div class="row-form">
                      <div class="col-sm-5">
                        ...
                        echo $Html->addAnchor('javascript:void(0)', '<i class="fa fa-question-circle"></i>', '', 'cms-help', array('data-content' => 'Zobrazí hlavní obsah stránky ve sloupcích <strong>col</strong>.<br>Pro zobrazení postranního panelu je nutné mít tuto položku zapnutou.<br> Nefunguje na <strong>Úvodní stránce</strong>.', 'data-original-title' => $tl["page_help"]["pageh"]));
                        ?>
                      ...
                      <div class="col-sm-7">
                        <div class="radio radio-success">
                          ...
                          <?php
                          // Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
                          echo $Html->addRadio('envo_sidebar_show', '1', ((isset($_REQUEST["envo_sidebar_show"]) && $_REQUEST["envo_sidebar_show"] == '1')) ? TRUE : FALSE, 'envo_sidebar_show1');
                          // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
                          echo $Html->addLabel('envo_sidebar_show1', $tl["checkbox"]["chk"]);

                          // Add Html Element -> addCheckbox (Arguments: name, value, checked, id, class, optional assoc. array)
                          echo $Html->addRadio('envo_sidebar_show', '0', ((isset($_REQUEST["envo_sidebar_show"]) && $_REQUEST["envo_sidebar_show"] == '0') || !isset($_REQUEST["envo_sidebar_show"])) ? TRUE : FALSE, 'envo_sidebar_show2');
                          // Add Html Element -> addLabel (Arguments: for, label, optional assoc. array)
                    ...
                    <div class="row-form" style="position: relative;">
                      ...
                      <div id="colposition" class="unrow active">
                        <div>
