    ...
    <div id="expenses_total" class="tile_count">
      <div class="row">
        <div class="col-md-2 col-sm-3 col-xs-12 tile_stats_count">
          <span class="count_top">Počet stránek</span>
          <div class="count"><?= $ENVO_STATS_COUNTALL ?></div>
        </div>
        <div class="col-md-2 col-sm-3 col-xs-12 tile_stats_count">
          <span class="count_top">Aktivní / Neaktivní stránky</span>
            ...
            <?php foreach ($ENVO_PAGE_ALL as $v) { ?>
              <tr>
                ...
                <td>
                  ...
                  <?php
                  // Add Html Element -> addAnchor (Arguments: href_link, text, id, class, optional assoc. array)
                  echo $Html->addAnchor('index.php?p=page&amp;sp=edit&amp;id=' . $v["id"], $v["title"], '', '', array('data-toggle' => 'tooltipEnvo', 'data-placement' => 'bottom', 'title' => $v["title"]));
                  ?>
