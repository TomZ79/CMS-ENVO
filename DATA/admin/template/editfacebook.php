        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            <div class="col-sm-5" style="padding-top: 15px;padding-bottom: 15px;">
              ...
              echo $Html->addImg($ENVO_FORM_DATA["pathoriginal"] . $ENVO_FORM_DATA["title"], array('alt' => '', 'class' => 'img-responsive', 'style' => 'border: 8px solid #fff;outline: 8px solid #f9f9f9;max-height: 270px;margin: 0 auto;'));
              ?>
          ...
          <div class="box-footer">
            ...
            echo $Html->addAnchor('index.php?p=facebookgallery&amp;sp=delete&amp;id=' . $ENVO_FORM_DATA["id"], 'Delete', '', 'btn btn-danger float-right', array('data-confirm' => sprintf($tl["fb_notification"]["del"], $ENVO_FORM_DATA["title"])));
            ?>
