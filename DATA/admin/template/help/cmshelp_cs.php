        ...
        <ul class="sub-menu no-padding">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-menu-child no-padding">
              ...
              <li class="nav-item"><a class="nav-link" href="#elementscdreate-checkboxf">LABELF - CHECKBOXF BUTTON</a>
              </li>
      ...
      <li class="nav-item">
        ...
        <ul class="sub-menu no-padding">
          <li class="nav-item">
            ...
            <ul class="sub-menu-child no-padding">
              <li class="nav-item"><a class="nav-link" href="#csmadminfunc_settings_blockiprange">Block IP Range</a>
              </li>
            </ul>
          </li>
        </ul>
