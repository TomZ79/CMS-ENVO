$(document).ready(function(){
	...
	$("#filer_input2").filer({
		...
		uploadFile: {
			url: "js-plugins/jquery-filter/examples/dragdrop/php/ajax_upload_file.php",
			data: null,
			type: 'POST',
		...
		onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
		    ...
		    $.post('js-plugins/jquery-filter/examples/dragdrop/php/ajax_remove_file.php', {file: file_name});
		},
		onEmpty: null,
		options: null,
		dialogs: {
