                  ...
                  <div class="block-content">
                      ...
                      <div class="col-md-6">
                        <div class="radio">
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_search" value="1"<?php if ($jkv["searchform"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk"]; ?>
                          </label>
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_search" value="0"<?php if ($jkv["searchform"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk1"]; ?>
                          </label>
                        </div>
                      </div>
                    </div>
                    <div class="row-form">
                      ...
                      <div class="col-md-6">
                        <div class="radio">
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_ajaxsearch" value="1"<?php if ($jkv["ajaxsearch"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk"]; ?>
                          </label>
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_ajaxsearch" value="0"<?php if ($jkv["ajaxsearch"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk1"]; ?>
                          </label>
                        </div>
                      </div>
                    </div>
                    <div class="row-form">
                      ...
                      <div class="col-md-6">
                        <div class="radio">
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_fullsearch" value="1"<?php if ($jkv["fulltextsearch"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk"]; ?>
                          </label>
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_fullsearch" value="0"<?php if ($jkv["fulltextsearch"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk1"]; ?>
                          </label>
                        </div>
