  ...
  <aside class="control-sidebar control-sidebar-dark hidden-xs">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar1">
        <h4><?php echo $tl["gs_section_tab"]["gstab"]; ?></h4>
        <p>Obecná nastavení pro ACP a webovou síť.</p>
        <hr>

        <!-- Emailová adresa -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc"]; ?></strong></h5>
        <p></p>

        <!-- HTTP or HTTPS -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc1"]; ?></strong></h5>
        <p></p>

        <!-- Jazyk -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc2"]; ?></strong></h5>
        <p>Výběr jazyka pro Administrační rozhraní ACP</p>

        <!-- Směr Textu -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc5"]; ?></strong></h5>
        <p></p>

        <!-- Formát Datumu -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc8"]; ?></strong></h5>
        <p>Formátu data.</p>

        <!-- Formát Času -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc9"]; ?></strong></h5>
        <p>Formát času.</p>

        <!-- Časová Zóna -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc10"]; ?></strong></h5>
        <p>Výběr časové zóny.</p>

        <!-- Zobrazení data a času -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc11"]; ?></strong></h5>
        ...
        <!-- Captcha -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc12"]; ?></strong></h5>
        <p></p>

        <!-- Zobrazit Formulář -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc13"]; ?></strong></h5>
        <p>Zobrazí nabídku na zobrazení kontaktního formuláře v layoutu stránky a v jednotlivých pluginech.</p>

        <!-- Choose how many -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc14"]; ?></strong></h5>
        ...
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc15"]; ?></strong></h5>
        ...
        <!-- Aktivovat RSS -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc16"]; ?></strong></h5>
        ...
        <!-- Items -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc17"]; ?></strong></h5>
        <p>Počet zobrazených posledních položek RSS Zpráv</p>

        <!-- Page Mid Range -->
        <h5><strong><?php echo $tl["gs_box_content"]["gsbc18"]; ?></strong></h5>
        <p></p>
      ...
      <div class="tab-pane" id="control-sidebar2">
        <h4><?php echo $tl["gs_section_tab"]["gstab1"]; ?></h4>
      ...
      <div class="tab-pane" id="control-sidebar3">
        <h4><?php echo $tl["gs_section_tab"]["gstab2"]; ?></h4>
        <hr>
      ...
      <div class="tab-pane" id="control-sidebar4">
        <h4><?php echo $tl["gs_section_tab"]["gstab3"]; ?></h4>
        <hr>
      ...
      <div class="tab-pane" id="control-sidebar5">
        <h4><?php echo $tl["gs_section_tab"]["gstab4"]; ?></h4>
        <hr>
