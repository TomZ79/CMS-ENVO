                  ...
                  <div class="block-content">
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7 col-xs-6">
                        <div class="radio">
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_showhits" value="1"<?php if ($JAK_FORM_DATA["showhits"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk"]; ?>
                          </label>
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_showhits" value="0"<?php if ($JAK_FORM_DATA["showhits"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk1"]; ?>
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7">
                        <div class="radio">
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_sidebar" value="1"<?php if ($JAK_FORM_DATA["sidebar"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk2"]; ?>
                          </label>
                          <label class="checkbox-inline">
                            <input type="radio" name="jak_sidebar" value="0"<?php if ($JAK_FORM_DATA["sidebar"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["checkbox"]["chk3"]; ?>
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row-form">
                      <div class="col-md-5 col-xs-6"><strong><?php echo $tl["news_box_content"]["newsbc19"]; ?></strong></div>
                      <div class="col-md-7 col-xs-6"><input type="checkbox" name="jak_delete_rate"/></div>
                    </div>
                    <div class="row-form">
                      <div class="col-md-5 col-xs-6"><strong><?php echo $tl["news_box_content"]["newsbc20"]; ?></strong></div>
                      <div class="col-md-7 col-xs-6"><input type="checkbox" name="jak_delete_hits"/></div>
                    </div>
                    <div class="row-form">
                      <div class="col-md-5 col-xs-6"><strong><?php echo $tl["news_box_content"]["newsbc21"]; ?></strong></div>
                      <div class="col-md-7 col-xs-6"><input type="checkbox" name="jak_update_time"/></div>
                    </div>
                  </div>
                </div>
              </div>
