...
/* 01. MODIFICATION - Responsive Bootstrap Tabs
 ========================================================================*/
/*
...
/* 02. MODIFICATION - INIT and CONFIG BOOTSTRAP TAGSINPUT PLUGIN
 ========================================================================*/
$(function() {
...
/* 03. MODIFICATION - SHOW/HIDE Help for each page
 ========================================================================*/
$(function() {
  // If Control sidebar exist than show control-sb button
  if( $('.control-sidebar').length ) {
    $('#control-sb').removeClass('hidden');
  }
});

/* 04. MODIFICATION - INIT and CONFIG BOOTSTRAP TOOLTIP
 ========================================================================*/
$(function() {
...
/* 05. JQUERY PASSY - Generating and analazing passwords, realtime.
 ========================================================================*/
/*
 * jQuery Passy
