...
$.AdminLTE.options = {
  ...
  //Activate sidebar PerfectScrollBar if the fixed layout is set (requires PerfectScrollBar Plugin)
  sidebarPerfectScroll: true,
...
function _init() {
  ...
  $.AdminLTE.layout = {
    ...
    fixSidebar: function () {
      ...
      //Enable
      if ($.AdminLTE.options.sidebarPerfectScroll) {
        if (typeof $.fn.perfectScrollbar != 'undefined') {
 ...
 * http://jqueryui.com
 * Includes: widget.js, data.js, scroll-parent.js, widgets/draggable.js, widgets/sortable.js, widgets/mouse.js, effect.js, effects/effect-highlight.js
