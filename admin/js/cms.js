...
(function (e) {
  ...
  }), e.ui.draggable, e.widget("ui.sortable", e.ui.mouse, {
    version: "1.11.4",
  ...
  }(), e.effects, e.effects.effect.highlight = function (t, i) {
...
!function (d) {
  ...
  var f = function (j, i) {
    ...
    this.fontAwesome = i.fontAwesome || this.element.data("font-awesome") || true;
    ...
    this.minuteStep = i.minuteStep || this.element.data("minute-step") || 15;
    ...
    this.todayHighlight = (i.todayHighlight || this.element.data("date-today-highlight") || true);
    this.weekStart = ((i.weekStart || this.element.data("date-weekstart") || e[this.language].weekStart || 1) % 7);
  ...
  var c = {
    ...
    parseDate: function (m, v, p, t) {
      ...
      if (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(m)) {
        v = this.parseFormat("dd-mm-yyyy", t)
      }
      if (/^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(m)) {
        v = this.parseFormat("dd-mm-yyyy hh:ii", t)
      }
