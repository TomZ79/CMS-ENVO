  	        ...
  	        <nav class="navbar navbar-static-top">
  	          ...
  	          <div class="navbar-custom-menu">
  	            <ul class="nav navbar-nav">
  	            	...
  	            	<?php } ?>
  	            	<li><a class="wIframe" data-title='CMS - FAQ' href="https://www.jakweb.ch/faq"><i class="fa fa-ambulance"></i><span class="hidden-xs hidden-sm"> <?php echo $tl["title"]["t21"];?></span></a></li>
