  ...
  <?php if (isset($JAK_HOOKS) && is_array($JAK_HOOKS)) foreach ($JAK_HOOKS as $v) { ?>
    ...
    <li id="widget-<?php echo $v["id"]; ?>" class="jakwidget">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <input type="checkbox" name="jak_hookshow[]"
                   value="<?php echo $v["id"]; ?>"<?php if (isset($JAK_ACTIVE_GRID) && is_array($JAK_ACTIVE_GRID)) foreach ($JAK_ACTIVE_GRID as $ag) {
      ...
      <div class="actions">
        ...
        <input type="hidden" name="horder[]" class="sorder" value="<?php echo $v["exorder"]; ?>"/> <input type="hidden"
                                                                                                          name="real_hook_id[]"
                                                                                                          value="<?php echo $v["id"]; ?>"/>
