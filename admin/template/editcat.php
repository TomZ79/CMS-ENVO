        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <table class="table table-striped">
              ...
              <?php } else { ?>
                <tr>
                  <td><?php echo $tl["cat"]["c13"]; ?> <a href="javascript:void(0)" class="cms-help"
                                                          data-content="<?php echo $tl["help"]["h1"]; ?>"
                  ...
                  <td><input type="text" name="jak_url" class="form-control"
                             value="<?php echo $JAK_FORM_DATA["exturl"]; ?>"/></td>
                </tr>
              <?php } ?>
              <tr>
                  ...
                  <div class="radio">
                    <label>
                      <input type="radio" name="jak_menu"
                             value="1"<?php if ($JAK_FORM_DATA["showmenu"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="jak_menu"
                             value="0"<?php if ($JAK_FORM_DATA["showmenu"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                    </label>
                  </div>
                </td>
              </tr>
