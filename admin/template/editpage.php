                      ...
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_showlogin"
                                 value="1"<?php if ($JAK_FORM_DATA["showlogin"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_showlogin"
                                 value="0"<?php if ($JAK_FORM_DATA["showlogin"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label>
                      </div>
                    </td>
                  </tr>
                      ...
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_shownav"
                                 value="1"<?php if ($JAK_FORM_DATA["shownav"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_shownav"
                                 value="0"<?php if ($JAK_FORM_DATA["shownav"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label>
                      </div>
                    </td>
                  </tr>
                      ...
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_showfooter"
                                 value="1"<?php if ($JAK_FORM_DATA["showfooter"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_showfooter"
                                 value="0"<?php if ($JAK_FORM_DATA["showfooter"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label>
                      </div>
                    </td>
                  </tr>
                      ...
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_showtags"
                                 value="1"<?php if ($JAK_FORM_DATA["showtags"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"]; ?>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_showtags"
                                 value="0"<?php if ($JAK_FORM_DATA["showtags"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"]; ?>
                        </label>
                      </div>
                    </td>
                  </tr>
                      ...
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_sidebar"
                                 value="1"<?php if ($JAK_FORM_DATA["sidebar"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g125"]; ?>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="jak_sidebar"
                                 value="0"<?php if ($JAK_FORM_DATA["sidebar"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g126"]; ?>
                        </label>
                      </div>
                    </td>
                  </tr>
                        ...
                        <?php if (isset($JAK_CAT) && is_array($JAK_CAT)) foreach ($JAK_CAT as $z) {
                          if ($z["id"] == $JAK_FORM_DATA["catid"]) { ?>
                            <option value="<?php echo $z["id"]; ?>"
                                    selected="selected"><?php echo $z["name"]; ?></option><?php }
                        } ?>
                      </select></td>
                  </tr>
                </table>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <textarea name="jak_css" id="jak_css"
                      class="form-control hidden"><?php echo $JAK_FORM_DATA["page_css"]; ?></textarea>
          </div>
          <div class="box-footer">
            <button type="submit" name="save"
                    class="btn btn-primary pull-right"><?php echo $tl["general"]["g20"]; ?></button>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <textarea name="jak_javascript" id="jak_javascript"
                      class="form-control hidden"><?php echo $JAK_FORM_DATA["page_javascript"]; ?></textarea>
          </div>
          <div class="box-footer">
            <button type="submit" name="save"
                    class="btn btn-primary pull-right"><?php echo $tl["general"]["g20"]; ?></button>
                        ...
                        <li class="jakcontent">
                          <div class="form-group">
                            ...
                            <select name="jak_showcontact" class="form-control">
                              <option
                                value="0"<?php if (isset($JAK_FORM_DATA["showcontact"]) && $JAK_FORM_DATA["showcontact"] == '0') { ?> selected="selected"<?php } ?>><?php echo $tl["cform"]["c18"]; ?></option>
                        ...
                        <li class="jakcontent">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <select name="jak_shownewsorder" class="form-control">
                                  <option
                                    value="ASC"<?php if (isset($JAK_FORM_DATA["shownewsorder"]) && $JAK_FORM_DATA["shownewsorder"] == "ASC") { ?> selected="selected"<?php } else { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g90"]; ?></option>
                                  <option
                                    value="DESC"<?php if (isset($JAK_FORM_DATA["shownewsorder"]) && $JAK_FORM_DATA["shownewsorder"] == "DESC") { ?> selected="selected"<?php } ?>><?php echo $tl["general"]["g91"]; ?></option>
                                </select>
                              </div>
                              <div class="col-md-6">
                                <select name="jak_shownewsmany" class="form-control">
                                  <?php for ($i = 0; $i <= 10; $i++) { ?>
                                    <option
                                      value="<?php echo $i ?>"<?php if (isset($JAK_FORM_DATA["shownewsmany"]) && $JAK_FORM_DATA["shownewsmany"] == $i) { ?> selected="selected"<?php } ?>><?php echo $i; ?></option>
                                  <?php } ?>
                                </select>
                              </div>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <select name="jak_shownews[]" multiple="multiple" class="form-control">
                              <option
                                value="0"<?php if (isset($JAK_FORM_DATA["shownews"]) && $JAK_FORM_DATA["shownews"] == 0) { ?> selected="selected"<?php } ?>><?php echo $tl["cform"]["c18"]; ?></option>
