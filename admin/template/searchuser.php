            ...
            <?php if (isset($JAK_SEARCH) && is_array($JAK_SEARCH)) foreach ($JAK_SEARCH as $v) { ?>
              <tr>
                ...
                <td><?php if (isset($JAK_USERGROUP_ALL) && is_array($JAK_USERGROUP_ALL)) foreach ($JAK_USERGROUP_ALL as $y) {
                    if ($v["usergroupid"] == $y["id"]) { ?><a
                      href="index.php?p=usergroup&amp;sp=user&amp;ssp=<?php echo $y["id"]; ?>"><?php echo $y["name"]; ?></a><?php }
                  } ?></td>
                <td><a class="btn btn-default btn-xs"
                       href="index.php?p=user&amp;sp=lock&amp;ssp=<?php echo $v["id"]; ?>"><i
                      class="fa fa-<?php if ($v["access"] == '1') { ?>check<?php } else { ?>lock<?php } ?>"></i></a>
                </td>
                <td><a class="btn btn-default btn-xs"
                ...
                <td><a class="btn btn-default btn-xs"
                       href="index.php?p=user&amp;sp=edit&amp;ssp=<?php echo $v["id"]; ?>"><i
