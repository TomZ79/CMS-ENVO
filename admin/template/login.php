<?php include "header.php"; ?>
  ...
  <div class="login-title">
    <h1><?php echo $jkv["title"]; ?>
      <small><?php echo $tl["login"]["l3"]; ?></small>
    </h1>
  </div>
  ...
  <div class="form-signin">
      ...
      <form role="form" id="login_form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
        <div class="form-group has-feedback">
          <input type="text" name="username" class="form-control" id="username"
                 placeholder="<?php echo $tl["login"]["l1"] . ' ' . $tl["general"]["g92"] . ' ' . $tl["login"]["l5"]; ?>">
    ...
    <div class="forgotP hide">
      ...
      <hr>
      <div class="btn btn-warning btn-block lost-pwd"><i
          class="fa fa-lightbulb-o"></i> <?php echo $tl["general"]["g71"]; ?></div>
    </div>
  </div>
