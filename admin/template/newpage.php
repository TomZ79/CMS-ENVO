  ...
  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
    ...
    <ul id="cmsTabNewP" class="nav nav-tabs nav-tabs-responsive nav-tabs-fillup" role="tablist">
      ...
      <li role="presentation" class="next">
        <a href="#cmsPage2" id="cmsPage2-tab" role="tab" data-toggle="tab" aria-controls="cmsPage2"
           aria-expanded="true">
                ...
                <div class="block">
                  <div class="block-content">
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_showtitle1" name="jak_showtitle"
                                 value="1"<?php if (isset($_REQUEST["showtitle"]) && $_REQUEST["showtitle"] == '1') { ?> checked="checked"<?php } ?> />
                          <label for="jak_showtitle1"><?php echo $tl["checkbox"]["chk"]; ?></label>

                          <input type="radio" id="jak_showtitle2" name="jak_showtitle"
                                 value="0"<?php if ((isset($_REQUEST["showtitle"]) && $_REQUEST["showtitle"] == '0') || !isset($_REQUEST["showtitle"])) { ?> checked="checked"<?php } ?> />
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_shownav1" name="jak_shownav"
                                 value="1"<?php if ((isset($_REQUEST["jak_shownav"]) && $_REQUEST["jak_shownav"] == '1') || !isset($_REQUEST["jak_shownav"])) { ?> checked="checked"<?php } ?> />
                          <label for="jak_shownav1"><?php echo $tl["checkbox"]["chk"]; ?></label>

                          <input type="radio" id="jak_shownav2" name="jak_shownav"
                                 value="0"<?php if (isset($_REQUEST["jak_shownav"]) && $_REQUEST["jak_shownav"] == '0') { ?> checked="checked"<?php } ?> />
                          <label for="jak_shownav2"><?php echo $tl["checkbox"]["chk1"]; ?></label>
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_showfooter1" name="jak_showfooter"
                                 value="1"<?php if ((isset($_REQUEST["jak_showfooter"]) && $_REQUEST["jak_showfooter"] == '1') || !isset($_REQUEST["jak_showfooter"])) { ?> checked="checked"<?php } ?> />
                          <label for="jak_showfooter1"><?php echo $tl["checkbox"]["chk"]; ?></label>

                          <input type="radio" id="jak_showfooter2" name="jak_showfooter"
                                 value="0"<?php if (isset($_REQUEST["jak_showfooter"]) && $_REQUEST["jak_showfooter"] == '0') { ?> checked="checked"<?php } ?> />
                          <label for="jak_showfooter2"><?php echo $tl["checkbox"]["chk1"]; ?></label>
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_showdate1" name="jak_showdate"
                                 value="1"<?php if (isset($_REQUEST["jak_showdate"]) && $_REQUEST["jak_showdate"] == '1') { ?> checked="checked"<?php } ?> />
                          <label for="jak_showdate1"><?php echo $tl["checkbox"]["chk"]; ?></label>

                          <input type="radio" id="jak_showdate2" name="jak_showdate"
                                 value="0"<?php if ((isset($_REQUEST["jak_showdate"]) && $_REQUEST["jak_showdate"] == '0') || !isset($_REQUEST["jak_showdate"])) { ?> checked="checked"<?php } ?> />
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_sidebar1" name="jak_sidebar"
                                 value="1"<?php if (isset($_REQUEST["jak_sidebar"]) && $_REQUEST["jak_sidebar"] == '1') { ?> checked="checked"<?php } ?> />
                          <label for="jak_sidebar1"><?php echo $tl["page_box_content"]["pagebc9"]; ?></label>

                          <input type="radio" id="jak_sidebar2" name="jak_sidebar"
                                 value="0"<?php if ((isset($_REQUEST["jak_sidebar"]) && $_REQUEST["jak_sidebar"] == '0') || !isset($_REQUEST["jak_sidebar"])) { ?> checked="checked"<?php } ?> />
                          <label for="jak_sidebar2"><?php echo $tl["page_box_content"]["pagebc10"]; ?></label>
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_social1" name="jak_social"
                                 value="1"<?php if (isset($_REQUEST["jak_social"]) && $_REQUEST["jak_social"] == '1') { ?> checked="checked"<?php } ?> />
                          <label for="jak_social1"><?php echo $tl["checkbox"]["chk"]; ?></label>

                          <input type="radio" id="jak_social2" name="jak_social"
                                 value="0"<?php if ((isset($_REQUEST["jak_social"]) && $_REQUEST["jak_social"] == '0') || !isset($_REQUEST["jak_social"])) { ?> checked="checked"<?php } ?> />
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_vote1" name="jak_vote"
                                 value="1"<?php if (isset($_REQUEST["jak_vote"]) && $_REQUEST["jak_vote"] == '1') { ?> checked="checked"<?php } ?> />
                          <label for="jak_vote1"><?php echo $tl["checkbox"]["chk"]; ?></label>

                          <input type="radio" id="jak_vote2" name="jak_vote"
                                 value="0"<?php if ((isset($_REQUEST["jak_vote"]) && $_REQUEST["jak_vote"] == '0') || !isset($_REQUEST["jak_vote"])) { ?> checked="checked"<?php } ?> />
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_showtags1" name="jak_showtags"
                                 value="1"<?php if (isset($_REQUEST["jak_showtags"]) && $_REQUEST["jak_showtags"] == '1') { ?> checked="checked"<?php } ?> />
                          <label for="jak_showtags1"><?php echo $tl["checkbox"]["chk"]; ?></label>

                          <input type="radio" id="jak_showtags2" name="jak_showtags"
                                 value="0"<?php if ((isset($_REQUEST["jak_showtags"]) && $_REQUEST["jak_showtags"] == '0') || !isset($_REQUEST["jak_showtags"])) { ?> checked="checked"<?php } ?> />
                          <label for="jak_showtags2"><?php echo $tl["checkbox"]["chk1"]; ?></label>
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7">
                        <div class="radio radio-success">
                          ...
                          <input type="radio" id="jak_showlogin1" name="jak_showlogin"
                                 value="1"<?php if (isset($_REQUEST["jak_showlogin"]) && $_REQUEST["jak_showlogin"] == '1') { ?> checked="checked"<?php } ?> />
                          <label for="jak_showlogin1"><?php echo $tl["checkbox"]["chk"]; ?></label>

                          <input type="radio" id="jak_showlogin2" name="jak_showlogin"
                                 value="0"<?php if ((isset($_REQUEST["jak_showlogin"]) && $_REQUEST["jak_showlogin"] == '0') || !isset($_REQUEST["jak_showlogin"])) { ?> checked="checked"<?php } ?> />
                          <label for="jak_showlogin2"><?php echo $tl["general"]["chk1"]; ?></label>
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7">
                        <input type="text" name="jak_password"
                               value="<?php if (isset($_REQUEST["jak_password"])) echo $_REQUEST["jak_password"]; ?>"
                               class="form-control"/>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row-form">
                      <div class="col-md-12">
                        <select name="jak_catid" class="form-control selectpicker" data-size="5">
                          <option
                            value="0"<?php if (!$page1) { ?> selected="selected"<?php } ?>><?php echo $tl["page_box_content"]["pagebc"]; ?></option>
                ...
                <div class="box-body">
                  <div class="block">
                    <div class="block-content">
                      ...
                      <div class="row-form">
                        <div class="col-md-12">
                          <input type="text" name="jak_tags" id="jak_tags" class="tags form-control"
                                 value="<?php if (isset($_REQUEST["jak_tags"])) echo $_REQUEST["jak_tags"]; ?>"
                                 data-role="tagsinput"/>
                        </div>
                      </div>
                    </div>
            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <a
                  ...
                  class="ifManager"><?php echo $tl["global_text"]["globaltxt8"]; ?></a>
                    ...
                    <li class="jakcontent">
                      <div class="form-group">
                        ...
                        <select name="jak_showcontact" class="form-control selectpicker" data-size="5">
                          <option
                            value="0"<?php if (isset($_REQUEST["jak_showcontact"]) && $_REQUEST["jak_showcontact"] == '0') { ?> selected="selected"<?php } ?>><?php echo $tl["global_text"]["globaltxt13"]; ?></option>
                  ...
                  <li class="jakcontent">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <select name="jak_shownewsorder" class="form-control selectpicker" data-size="5">
                            <option
                              value="ASC"<?php if (isset($_REQUEST["jak_shownewsorder"]) && $_REQUEST["jak_shownewsorder"] == "ASC") { ?> selected="selected"<?php } else { ?> selected="selected"<?php } ?>><?php echo $tl["global_text"]["globaltxt10"]; ?></option>
                            <option
                              value="DESC"<?php if (isset($_REQUEST["jak_shownewsorder"]) && $_REQUEST["jak_shownewsorder"] == "DESC") { ?> selected="selected"<?php } ?>><?php echo $tl["global_text"]["globaltxt11"]; ?></option>
                          </select>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select name="jak_shownews[]" multiple="multiple" class="form-control">
                        <option
                          value="0"<?php if (isset($_REQUEST["jak_shownews"]) && $_REQUEST["jak_shownews"] && in_array(0, $_REQUEST["jak_shownews"])) { ?> selected="selected"<?php } else { ?> selected="selected"<?php } ?>><?php echo $tl["global_text"]["globaltxt13"]; ?></option>
