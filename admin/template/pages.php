    ...
    <div class="col-md-6">
      <form role="form" method="post" action="/admin/index.php?p=page&amp;sp=search&amp;ssp=go">
        <div class="input-group">
          ...
          <input type="text" name="jakSH" class="form-control" placeholder="Search by Title">
        </div><!-- /input-group -->
      </form>
    </div>
  </div>
          ...
          <table class="table table-striped table-hover">
            ...
            <?php if (isset($JAK_PAGE_ALL) && is_array($JAK_PAGE_ALL)) foreach ($JAK_PAGE_ALL as $v) { ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-default btn-xs" href="index.php?p=page&amp;sp=delete&amp;ssp=<?php echo $v["id"]; ?>" onclick="if(!confirm('<?php echo $tl["page"]["al"]; ?>'))return false;">
                    <i class="fa fa-trash-o"></i>
                  </a>
                </td>
              </tr>
