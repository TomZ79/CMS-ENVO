      ...
      <tr>
        <td>
          <?php if ($jkv["adv_editor"]) { ?>
            <p><a
                href="../js/editor/plugins/filemanager/dialog.php?type=0&editor=mce_0&lang=eng&fldr=&field_id=htmleditor"
            ...
            <textarea name="jak_content" class="form-control hidden"
                      id="jak_editor"><?php echo jak_edit_safe_userpost(htmlspecialchars($JAK_FORM_DATA["content"])); ?></textarea>
          <?php } else { ?>
