...
<nav class="secondary-sidebar padding-30" id="myScrollspy">
  <ul class="nav main-menu">
    <li class="active">
      <a href="#introduction">
        <span class="title"><i class="pg-sent"></i> Introduction</span>
      </a>
      <ul class="sub-menu no-padding">
        ...
        <li>
          <a href="#supported_browsers">
            <span class="title">Browser Support</span>
          </a>
        </li>
        <li>
          <a href="#requirements">
            <span class="title">Minimum requirements</span>
          </a>
        </li>
        <li>
          <a href="#installation">
...
<div class="inner-content padding-20">
  ...
  <section id="requirements" class="scrollspyoffset">
    <h2 class="text-center">Minimum requirements</h2>
    <hr>
