                  ...
                  <div class="block-content">
                    <div class="row-form">
                      ...
                      <div class="col-md-7">
                        <div class="form-group no-margin">
                          ...
                          echo $Html->addInput('text', 'jak_title', $JAK_SETTING_VAL["newstitle"], '', 'form-control');
                          ?>
                    ...
                    <div class="row-form">
                      ...
                      <div class="col-md-7">
                        ...
                        echo $Html->addTextarea('jak_lcontent', envo_edit_safe_userpost($JAK_SETTING_VAL["newsdesc"]), '4', '', array('class' => 'form-control'));
                        ?>
