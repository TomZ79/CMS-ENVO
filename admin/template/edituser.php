        ...
        <div class="table-responsive">
          <table class="table table-striped v-text-center">
            ...
            <tr>
              ...
              <td><input type="text" name="jak_backtime" id="datepicker" class="form-control"
                         value="<?php echo $JAK_FORM_DATA["backtime"]; ?>"/></td>
            </tr>
            <tr>
              ...
              <td>
                <div class="fileinput fileinput-new" data-provides="fileinput">
                  <div class="fileinput-preview thumbnail" data-trigger="fileinput"
                    ...
                    <img
                      src="<?php echo BASE_URL_ORIG . basename(JAK_FILES_DIRECTORY) . '/userfiles/' . $JAK_FORM_DATA["picture"]; ?>"
                      alt="avatar" class="img-polaroid"/>
                  </div>
                  <div>
                    <span class="btn btn-default btn-file"><span
                        class="fileinput-new"><?php echo $tl["general"]["g132"]; ?></span><span
                        class="fileinput-exists"><?php echo $tl["general"]["g131"]; ?></span><input type="file"
                                                                                                    name="uploadpp"
                                                                                                    accept="image/*"></span>
                    <a href="#" class="btn btn-default fileinput-exists"
                       data-dismiss="fileinput"><?php echo $tl["general"]["g130"]; ?></a>
                  </div>
                </div>
              </td>
            </tr>
