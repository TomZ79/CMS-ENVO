        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tr>
              ...
              <th></th>
              <th>
                <button type="submit" name="delete" id="button_delete" class="btn btn-danger btn-xs" data-confirm-del="<?php echo $tl["cform"]["al"]; ?>" disabled="disabled">
            ...
            <?php foreach ($JAK_CONTACT_ALL as $v) { ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-default btn-xs" href="index.php?p=contactform&amp;sp=delete&amp;ssp=<?php echo $v["id"]; ?>" data-confirm="<?php echo $tl["cform"]["al"]; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $tl["icons"]["i1"]; ?>">
                    <i class="fa fa-trash-o"></i>
                  </a>
                </td>
              </tr>
