        ...
        <table class="table table-striped table-hover">
          ...
          <?php foreach ($JAK_USER_ALL_APPROVE as $va) { ?>
            <tr>
              ...
              <td>
                <input type="checkbox" name="jak_delete_user[]" class="highlight" value="<?php echo $va["id"]; ?>"/>
              </td>
              <td>
              ...
              <td>
                <a class="btn btn-default btn-xs" href="index.php?p=user&amp;sp=password&amp;ssp=<?php echo $va["id"]; ?>" onclick="if(!confirm('<?php echo $tl["user"]["pass"]; ?>'))return false;">
                  <i class="fa fa-key"></i>
                </a>
              </td>
              <td>
              ...
              <td>
                <a class="btn btn-default btn-xs" href="index.php?p=user&amp;sp=delete&amp;ssp=<?php echo $va["id"]; ?>" onclick="if(!confirm('<?php echo $tl["user"]["al"]; ?>'))return false;">
                  <i class="fa fa-trash-o"></i>
                </a>
              </td>
            </tr>
        ...
        <table class="table table-striped table-hover">
          ...
          <?php if (isset($JAK_USER_ALL) && is_array($JAK_USER_ALL)) foreach ($JAK_USER_ALL as $v) { ?>
            <tr>
              <td><?php echo $v["id"]; ?></td>
              <td>
                <input type="checkbox" name="jak_delete_user[]" class="highlight" value="<?php echo $v["id"]; ?>"/>
              </td>
              <td>
