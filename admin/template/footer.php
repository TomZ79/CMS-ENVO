...
if (!empty($page)) {
  ...
  } elseif (!in_array($page, $ap) && !empty($page)) {
...
<script type="text/javascript">
  $.notify({
    ...
    timer: 8000,
    template:
    '<div data-notify="container" class="col-xs-11 col-sm-3 alert" role="alert" style="background-color: #263238;color: #fff">' +
...
<script type="text/javascript">$.notify({icon: 'fa fa-info-circle', message: '<?php echo $_SESSION["infomsg"];?>'}, {type: 'info'});</script>
<?php } if (isset($_SESSION["successmsg"])) { ?>
<script type="text/javascript">$.notify({icon: 'fa fa-check-square-o', message: '<?php echo $_SESSION["successmsg"];?>'}, {type: 'success'});</script>
<?php } if (isset($_SESSION["errormsg"])) { ?>
<script type="text/javascript">$.notify({icon: 'fa fa-exclamation-triangle', message: '<?php echo $_SESSION["errormsg"];?>'}, {type: 'danger'});</script>
<?php } ?>
